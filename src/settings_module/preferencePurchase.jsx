...
export default class Sales extends React.Component {
        ...
        if (this.state.pageSelected == "Estimate") {
            ...
            if (this.state.estimate_edit == false) {
                ...
                FetchAllApi.create_sales_estimate_edit(estimate, (err, response) => {
                    if (response.status === 1) {
                        alert("Estimate Edited successfully")
                    }
                })
            };
            ...
            let invoice = {
                ...
                invoice_default_due_date: this.state.invoice_due_date,
    ...
    render() {
        console.log("letme", this.state.default_category_list)
        return (
            <React.Fragment>
        ...
        <h3>Subscribers</h3>
                        ...
                        <div className="user-cont-right">
                            ...
                            <div className="col-md-12 col-xs-12">
                                <div className="row">
                                    <ul className="nav nav-pills transparent nowrap ofx-auto">
                                        <li class="active"><a data-toggle="pill" href="#purchase-order" onClick={() => { this.selectedPage("Purchase Order") }}>Purchase Order</a></li>
                                ...
                                <div className="row tab-content mar-top pad-top">
                                    ...
                                    <div id="purchase-order" className="col-md-12 tab-pane fade active in pad-no">
                                        <form className="custom-form col-lg-4 col-md-8">
                                            <div className="row">
                                                <div className="form-group">
                                                    <div className="input-group half-input">
                                                        <div>
                                                            <label className="label-nowrap">Purchase Order Prefix</label>
                                                            <input type="text" className="form-control" name="purchase_order_prefix" value={this.state.purchase_order_prefix} onChange={this.change} />
                                                        </div>
                                                        <div>
                                                            <label>Next No#</label>
                                                            <input type="text" className="form-control" name="purchase_next_no" value={this.state.purchase_next_no} onChange={this.change} />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="form-group">
                                                    <label>Thank you message and Banking details</label>
                                                    <textarea className="form-control" cols={10} rows={6} defaultValue={""} name="purchase_thanking_message" value={this.state.purchase_thanking_message} onChange={this.change} />
                                                </div>
                                                <div className="form-group">
                                                    <label>Terms &amp; Conditions</label>
                                                    <textarea className="form-control" cols={10} rows={6} defaultValue={""} name="purchase_terms" value={this.state.purchase_terms} onChange={this.change} />
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                                    <div id="poservices" className="col-md-12 tab-pane fade in pad-no">
                                        <div className="col-md-12 col-xs-12 pad-no">
                                            <div className="pills-search">
                                                <div>
                                                    <button className="btn btn-blue add-new" data-toggle="modal" data-target="#poadd_items" onClick={this.newFunc}>
                          ...
                          <div className="form-group search-box mar-no">
                            <input type="text" name="search" className="form-control" placeholder="Search..." />
                                        ...
                                        {this.state.poserviceList.length == 0 ? (
                                  ...
                                  <span className="checkmark" />
                                                        ...
                                                        <tbody>
                                                            {this.state.poserviceList.map((serv, idx) => {
                                                                return (
                                                                    <tr>
                                                                        <td>
                                                                            <label className="custom-checkbox small">
                                  ...
                                  <span className="checkmark" />
                                    ...
                                    <span className="caret" /></button>
                                                                                <ul className="dropdown-menu align-right">
                                                                                    <li><a href="javascript:;" data-toggle="modal" data-target="#poadd_items" onClick={() => { this.editFunc(serv) }}>Edit</a></li>
                                                                                    <li><a href="javascript:;" onClick={() => { this.deletePOServiceItem(serv, 0) }}>Delete</a></li>
                                                                                    {/* <li><a href="javascript:;" onClick={()=>{this.deletePOServiceItem(serv.item_id,serv.status)}}>Inactive</a></li> */}
                                                                                </ul>
                                                                            </div>
                                                                        </td>
                                                                    </tr>
                    ...
                    {this.state.pageSelected == "poservices" ? (
                        null
                    ) : (
