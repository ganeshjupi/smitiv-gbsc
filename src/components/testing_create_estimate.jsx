...
class invoice_template_listing extends React.Component {
    ...
    frontPrint = () => {
        ...
        jQuery("#p-invoice_number").html(aa.estimate_number)
        ...
        jQuery("#template_name").html("QUOTATION")
        }
        ...
        setTimeout(() => {
            ...
            let estimate_id = this.state.invoice_id_used
            ...
            fetch("https://api.genie.com.sg/save_estimate_as_pdf_with_html", {
                method: "POST",
                body: JSON.stringify({
                    client_id,
                    estimate_id,
    ...
    saveAsPdf = () => {
        ...
        let Input = {
            client_id: this.state.logged_client_id,
            estimate_id: this.state.estimate_id ? this.state.estimate_id : this.state.estimate_id_for_print,
            template_id: this.state.template_id
        }
        ...
        FetchAllApi.print_pdf(Input, 'estimate', (err, response) => {
            if (response.status === 1) {
    ...
    handleChange = (selected_option) => {
        if (selected_option == "Create New") {
            ...
            localStorage.setItem("selected_customer_id",variable_pay_type);
            this.setState(
                {
    ...
    get_invoice_list = () => {
        let input = { client_id: this.state.logged_client_id, user_id: this.state.logged_user_id, selected_template_type: 3 }
    ...
    delete_or_void_estimate = (val) => {
        ...
        FetchAllApi.delete_or_void_estimate(
            input,
            (err, response) => {
                if (response.status === 1) {
                    alert(response.message)
    ...
    async componentDidMount() {
        ...
        // setTimeout(() => {
        await this.next_estimate_number();
        // }, 5000);
        ...
        if (this.props.location.state != undefined) {
            if (this.props.location.state.detail != undefined) {
                ...
                if (data.itemlist.length > 0) {
                    ...
                    await this.handleChangeItems(data.itemlist.length);
            ...
            if (this.props.location.state.invoicecreditmemo != undefined) {
                ...
                this.customerjoblist(this.state.customer_id);
                // }, 2000);
        ...
        if ((localStorage.getItem("copy_estimate") != '' && localStorage.getItem("copy_estimate") != undefined && localStorage.getItem("copy_estimate") != null) || (localStorage.getItem("copy_salesorder") != '' && localStorage.getItem("copy_salesorder") != undefined && localStorage.getItem("copy_salesorder") != null)) {
            setTimeout(() => { this.copy_estimate(); }, 1000)
        };
    ...
    appendInvoiceDetails = () => {
        ...
        if (setID !== null && setID !== '' && setID !== undefined) {
            ...
            if (localBee.length > 1) {
                ...
                var estimate_id = localBee[0]


                var invoice_id = localBee[0];
                var payment_id = 0;
                this.setState({ paymentGRTR: Number(payment_id), edited: true, estimate_id, estimate_id_for_print: estimate_id, client_id });
            } else {
            ...
            if (invoice_id != undefined && invoice_id != "" && invoice_id != null) {
                ...
                // setTimeout(() => {
                FetchAllApi.get_estimate_details(coreData, (err, response) => {
                    // console.log("vendor_names", response);
                    // alert('rightu')f
                    if (response.status === 1) {
                        ...
                        this.setState({ selectCustomer: primaryData.customer_id, JobId: primaryData.job_id });
                        ...
                        jQuery("#invoice_no").val(primaryData.estimate_number);
                        // }, 6000);
    ...
    changeEstimatetoinvoice = () => {       
        ...
        let item_list = this.state.dummarray;
        ...
        if (
            ...
            if (
                ...
                if (!this.state.isInvoiceEditable || this.state.isInvoiceEditable) {
                    ...
                    if (payable_amount == "" || payable_amount == undefined) {
                        localStorage.setItem("change_invoice_estimate", JSON.stringify(data))
        ...
        if (
            ...
            if (
                ...
                if (!this.state.isInvoiceEditable || this.state.isInvoiceEditable) {
                    ...
                    if (payable_amount == "" || payable_amount == undefined) {
                        if (input == "salesOrder") {
                            localStorage.setItem("change_salesorder", JSON.stringify(data))
                            window.open("/create_salesorder");
                        } else if (input == "copy") {
                            localStorage.setItem("copy_estimate", JSON.stringify(data))
                            window.open("/create_estimate");
    ...
    copy_estimate = () => {
        var primaryData = JSON.parse(localStorage.getItem("copy_estimate"))
        ...
        if (localStorage.getItem("change_invoice_sales") != '' && localStorage.getItem("change_invoice_sales") != null && localStorage.getItem("change_invoice_sales") != undefined) {
            ...
            this.setState({ sales_order_id: primaryData.id });
        }
        if (localStorage.getItem("change_invoice_estimate") != '' && localStorage.getItem("change_invoice_estimate") != null && localStorage.getItem("change_invoice_estimate") != undefined) {
            ...
            this.setState({ estimate_id: primaryData.id });
        }
        ...
        jQuery('#reference').val(primaryData.payment_date);
        if (localStorage.getItem("copy_estimate") != '' && localStorage.getItem("copy_estimate") != null && localStorage.getItem("copy_estimate") != undefined) {

            localStorage.setItem("copy_estimate", "")
        }
            ...
            if (
                ...
                if (!this.state.isInvoiceEditable || this.state.isInvoiceEditable) {
                    ...
                    if (payable_amount == "" || payable_amount == undefined) {
                        ...
                        FetchAllApi.create_estimate(data, (err, response) => {
                            ...
                            if (response.status === 1) {
                                if (btn_type === "save") {
                                    ...
                                    // for pdf print
                                    this.setState({ isInvoiceEditable: true, invoice_id_used: response.estimate_id, estimate_id: response.estimate_id, estimate_id_for_print: response.estimate_id });
                                    // for pdf print
                                    ...
                                    // this.props.history.push("/loading", ["/create_estimate"]);
                                    ...
                                    FetchAllApi.create_estimate(data, (err, response) => {
                                        ...
                                        if (response.status === 1) {
                                            if (btn_type === "save") {
                                                ...
                                                //     "/all_lists",
                                                // ]);
                                                this.setState({ isInvoiceEditable: true, invoice_id_used: response.estimate_id, estimate_id: response.estimate_id });
    ...
    next_estimate_number = () => {
        ...
        FetchAllApi.next_estimate_number(coreData, (err, response) => {
            // console.log("vendor_names", response);
            // alert('rightu')
            if (response.status === 1) {
    ...
    render() {
        ...
        // console.log('hfggsdgsdhhhhh1', this.state.rows)
        var data = "";
                ...
                <div id="mynode">
                            ...
                            <div className="main-wrap col-md-12 col-xs-12 pad-r-no">
                                <div className="top-bar col-md-12 col-xs-12 pad-r-no">
                                    ...
                                    <ul class="list-unstyled breadcrumb page-title hidden-xs">
                                        <li>
                                            <a href="javascript: ;">Create Quotation</a>
                                        </li>
                                ...
                                <div>
                                    <div className="content-top col-md-12 col-xs-12">
                                        ...
                                        >
                                            ...
                                            >
                                                <label>Quotation Currency<span className="astrick">*</span></label>
                                                <div>
                                                    <select
                      ...
                      <converter ref={this.child} />
                            ...
                            />
                                                ...
                                                <div
                                                    ...
                                                    id="itemoptioninvoicenostatus"
                                                >
                                                    <label>Quotation No<span className="astrick">*</span></label>
                                                    <input
                                                        type="text"
                                                        name="inv-no"
                                                        className="form-control"
                  ...
                  >
                    ...
                    />
                                                ...
                                                >
                                                    <label>Quotation to<span className="astrick">*</span></label>
                                                    <textarea
                                                        id="invoice_to"
                                                        className="form-control"
                    ...
                    */}
                                            ...
                                            <div className="pf-btm-wrap">
                                                ...
                                                <div className="col-md-6 col-sm-6 col-xs-12 text-right pad-no pull-right">
                                                    {this.state.isInvoiceEditable &&
                                                         <>                                                           
                                                            ...
                                                            <ul className="dropdown-menu category">
                                                                <li><a onClick={() => { this.changeSalesOrder("copy") }} >Create a copy</a></li>
                                                                <li><a data-toggle="modal" data-target="#modal_delete_invoice"
                                                                // onClick={() => this.delete_or_void_estimate(10)} 
                                                                >Delete</a></li>
                                                                <li><a data-toggle="modal" data-target="#modal_void_invoice"
                                                                // onClick={() => this.delete_or_void_estimate(11)}
                                                                >Void</a></li>
                                                                <li><a href="javascript:;" onClick={() => { this.changeSalesOrder("salesOrder") }} >Create sales order</a></li>
                                                    ...
                                                    {/* {!this.state.isInvoiceEditable &&  */}
                                                    <button
                                                        className="btn btn-yellow mar-rgt-5"
                                                        type="button"
                            ...
                            <div className="modal-content">
                                <div className="modal-body text-center">
                                    ...
                                    <form className="custom-form row">
                                        ...
                                        <div className="form-group col-md-12 col-xs-12 mh btn-sec text-center mar-b-no">
                                            <button className="btn btn-lightgray mar-rgt-5" data-dismiss="modal">Cancel</button>
                                            <input type="button" data-toggle="modal" data-target="#table_items_pop_up" className="btn btn-green mar-rgt-5" value="OK" onClick={this.changeEstimatetoinvoice} />
                                        </div>
                                    </form>
                                </div>
                                                ...
                                                FetchAllApi.delete_or_void_estimate(
                                                    ...
                                                    (err, response) => {
                                                        if (response.status === 1) {
                                                            ...
                                                            window.location.href = "/all_lists"
                                                            // window.open('/all_lists')
                                                            // window.jQuery('#paid_invoice_delete_modal').show('hide')
                                                            // this.props.history.push('/all_lists')
                                                        } else {
                                                            alert(response.message)
                                                        }
                    ...
                    {/* modal for paid_invoice_void_modal  */}
