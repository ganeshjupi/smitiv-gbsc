...
class footer extends React.Component {
  ...
  UNSAFE_componentWillMount() {
    ...
    FetchAllApi.defaultcategorylist(client_id, (err, response) => {
      ...
      if (response.status === 1) {
        console.log('reder', response.list)
        this.setState({
  ...
  saveNew_Account = e => {
    ...
    console.log('jsdcsd', account_name, '=', category_id, '=', sub_category_id, '=', account_type_id, '=', sub_Account_id)
      ...
      FetchAllApi.save_NewAccountName(items, (err, response) => {
        ...
        if (response.status === 1) {
          ...
          if (this.props != undefined && this.props != null && this.props.defaultcategorylist_onchange != undefined && this.props.defaultcategorylist_onchange != null && this.props.defaultcategorylist_onchange != '') {
            this.props.defaultcategorylist_onchange('added', this.state.account_name, response.account_id)
  ...
  categoryFunc = () => {
    ...
    FetchAllApi.defaultcategorylist(client_id, (err, response) => {
      ...
      if (response.status === 1) {
        ...
        this.props.defaultcategorylist_onchange(response.list)
      } else {
      }
    })
  }
  ...
  fetch_sub_Account_type = (name, val) => {
    ...
    FetchAllApi.get_sub_Accounttype(sub_Account_id, client_id, (err, response) => {
      ...
      if (response.status === 1) {
        ...
        this.setState({ Account_type_name: name, Account_type_id: val })
      }
    })
  }
                      ...
                      <div className='form-group col-md-12 col-xs-12 pad-no'>
                        ...
                        <div className="col-md-8 col-sm-8 col-xs-12">
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              let a = this.state.sub_account_list.find(k => k.id == e.target.value)
                             // alert(a.name)
                             // alert(a.id)
                              this.setState({
                                sub_Account_name: a.name,
