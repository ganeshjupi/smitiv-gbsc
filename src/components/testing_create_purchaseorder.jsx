...
class Testing_create_purchaseorder extends React.Component {
    constructor(props) {
        super(props);
    ...
    frontPrint = () => {
        ...
        jQuery("#p-invoice_number").html(aa.purchaseorder_number)
        ...
        jQuery("#template_name").html("PURCHASE ORDER")
        }
        ...
        setTimeout(() => {
            ...
            let purchase_order_id = this.state.invoice_id_used
            ...
            fetch("https://api.genie.com.sg/save_purchase_order_as_pdf_with_html", {
                method: "POST",
                body: JSON.stringify({
                    client_id,
                    purchase_order_id,
    ...
    saveAsPdf = () => {
        ...
        let Input = {
            client_id: this.state.logged_client_id,
            purchase_order_id: this.state.purchase_order_id ? this.state.purchase_order_id : this.state.invoice_id_used,
            template_id: this.state.template_id
        }
        ...
        FetchAllApi.print_pdf(Input, 'purchaseorder', (err, response) => {
            if (response.status === 1) {
                alert(response.message)
    ...
    get_invoice_list = () => {
        let input = { client_id: this.state.logged_client_id, user_id: this.state.logged_user_id, selected_template_type: 5 }
    ...
    delete_or_void_purchase_order = (val) => {

        let input = {
            client_id: this.state.logged_client_id,
            purchase_order_id: this.state.purchase_order_id,
            status_to_set: val

        }

        FetchAllApi.delete_or_void_purchase_order(
            input,
            (err, response) => {
                if (response.status === 1) {
                    alert(response.message)
    ...
    createNewVendor = () => {
        ...
        setInterval(() => {
            ...
            var customer = localStorage.getItem("third_party_customer");
            ...
            if (
                ...
                FetchAllApi.getVendorNames(
                    ...
                    (err, response) => {
                        ...
                        if (response.status === 1) {
                            this.setState({ vendor_names: response.list, vendor_id: localStorage.getItem('third_party_customer_id') },
                                () => {
                                    localStorage.setItem("third_party_customer_id", '')
                                    localStorage.setItem("third_party_customer", '');
                                })
    ...
    async componentDidMount() {
        ...
        // setTimeout(() => {
        await this.next_purchase_order_number();
        // }, 5000);
        ...
        jQuery('#customer_id').val(this.state.customer_id);
        if(this.state.customer_id !=''){
        let obj =  this.state.vendor_names.find((e)=> e.id == this.state.customer_id)
        if(obj && obj!='')
        this.setState({ vendor_id: this.state.customer_id,billing_address: obj.billing_address,shipping_address: obj.shipped_address })
        }
    ...
    appendInvoiceDetails = () => {
        ...
        if (setID !== null) {
            ...
            if (localBee.length > 1) {
                ...
                var purchase_order_id = localBee[0]


                var invoice_id = localBee[0];
                var payment_id = 0;
                this.setState({ paymentGRTR: Number(payment_id), edited: true, client_id, purchase_order_id, });
            } else {
            ...
            if (invoice_id != undefined && invoice_id != "" && invoice_id != null) {
                ...
                this.setState({ purchase_order_id: invoice_id, loading: true })
                // setTimeout(() => {
                FetchAllApi.get_purchase_order_details(coreData, (err, response) => {
                    // alert('rightu')f
                    if (response.status === 1) {
                        ...
                        this.setState({ selectCustomer: primaryData.customer_id, customerID: primaryData.customer_id });
                        ...
                        jQuery("#invoice_no").val(primaryData.purchaseorder_number);
                        jQuery("#customer_id").val(primaryData.vendor_id);
                        this.setState({ vendor_id: primaryData.vendor_id })
                        jQuery("#variable_pay_type").val(primaryData.customer_id);
                        jQuery("#jobName").val(primaryData.job_name);
                        // }, 6000);
                        ...
                        FetchAllApi.create_purchaseorder(data, (err, response) => {
                            ...
                            if (response.status === 1) {
                                ...
                                if (btn_type === "save") {
                                    ...
                                    this.setState({ isInvoiceEditable: true, invoice_id_used: response.purchase_order_id, purchase_order_id: response.purchase_order_id });
    ...
    next_purchase_order_number = () => {
        ...
        FetchAllApi.next_purchase_order_number(coreData, (err, response) => {
            // alert('rightu')
            if (response.status === 1) {
                                ...
                                <div>
                                    <div className="content-top col-md-12 col-xs-12">
                                        ...
                                        >
                                            ...
                                            >
                                                <label>Purchase Order Currency<span className="astrick">*</span></label>
                                                <div>
                                                    <select
                                  ...
                                  >
                                    {data[item].code}
                                            ...
                                            <div className="form-group col-md-3 col-sm-4" >
                                                <label>Drop to ship<span className="astrick">*</span></label>
                                                <div>
                                                    <select
                                                        className="selectpicker form-control add-new hh w-100"
                                                        data-live-search="true"
                                    ...
                                    <div className="content-sec col-md-12 col-xs-12 pad-no mar-t-no">
                                        <form className="custom-form invoice-form">
                                            <div className="row">
                                                ...
                                                <div className='form-group col-lg-4 col-md-6 col-sm-6 col-xs-12'>
                                                    <label>Vendor  Name<span className="astrick">*</span></label>
                                                    <select
                                                        className='selectpicker form-control add-new'
                                                        data-live-search='true'
                                                        title='Choose...'
                                                        ...
                                                        onChange={(e) => {
                                                            let  value = e.target.value
                                                            if (value == 'add_new') {
                                                                window.open("/add_new_vendor", "_blank")
                                                            } else {
                                                                let obj =  this.state.vendor_names.find((e)=> e.id == value)
                                                                this.setState({ vendor_id: value,billing_address: obj.billing_address,shipping_address: obj.shipped_address })
                            ...
                            <div class="modal-dialog modal-md" style={{ width: 440 }}>
                                ...
                                <div class="modal-content">
                                    <div class="modal-body text-center success-modal">
                                        ...
                                        <p class="fw-500">This Purchase order will be voided </p>
                                        <button
                                            className="btn btn-lightgray btn-align"
                                            data-dismiss="modal"
                                        >
                                        ...
                                        <button
                                            ...
                                            onClick={() => this.delete_or_void_purchase_order(11)}
                                        >
                                            Make Void
                                        </button>
                                    </div>
              ...
              <div class="modal-dialog modal-md" style={{ width: 440 }}>
                ...
                <div class="modal-content">
                  <div class="modal-body text-center success-modal">
                    ...
                    <p class="fw-500">This Purchase order will be deleted </p>
                    <button
                      className="btn btn-lightgray btn-align"
                      data-dismiss="modal"
                    >
                    ...
                    <button
                      ...
                      onClick={() => this.delete_or_void_purchase_order(10)}
                    >
                      Delete
                    </button>
                  </div>
...
export default Testing_create_purchaseorder;