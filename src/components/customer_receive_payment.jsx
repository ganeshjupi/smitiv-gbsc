...
class Customer_receive_payment extends React.Component {
  constructor(props) {
    super(props);
  ...
  dateChange = (e,input) => {
    ...
    setTimeout(() => this.get_currency_datails(input), 500)
  };




  get_currency_datails = (input) => {
        ...
        fetch(
          ...
          .then((data) => {
            ...
            if (this.state.clientHomeCurrency != '' && this.state.clientHomeCurrency != undefined) {
              ...
              if(input==="refund")
              {
                let exval=(newObj[this.state.clientHomeCurrency]).toFixed(4)
                jQuery("#refund_exchange").val(exval)
              }
  ...
  applyCredit = () => {
    ...
    if ((Number(this.state.amount_of_payment) + this.state.TotalCreditAmount + this.state.TotalDiscountAmount) < Due_Total && Due_Total) {     
      let under_amt = Due_Total - ((Number(credit_amount_total)+Number(this.state.amount_of_payment) + Number(this.state.TotalCreditAmount) + Number(this.state.TotalDiscountAmount)))     
  ...
  get_customer_multipayment_details = () => {
    ...
    FetchAllApi.get_customer_multipayment_details(input, (err, response) => {
      if (response.status === 1) {
        ...
        this.setState({
          ...
          currency_selected: data.payment_currency,
          ...
          console.log(this.state.vendor_credit_list);
          ...
          jQuery("#refund_date").val(data.refund ? moment(data.refund.refund_date).format("DD/MM/YYYY") : '')
  ...
  componentDidMount() {
    ...
    console.log(this.state.edit_customer_receive_payment);
    console.log( this.state.edit_customer_receive_payment != '' &&
    this.state.edit_customer_receive_payment != null &&
    this.state.edit_customer_receive_payment != undefined)
    if (
  ...
  addDiscount = (e) => {
    ...
    if (
      ...
      this.setState({
        ...
        [`discount_account_type${this.state.invoiceSeletedId}`]: this.state[`discount_account_type_temp${this.state.invoiceSeletedId}`]
      })
      jQuery('.discount-wrap').slideToggle();
      setTimeout(
        function () {
  ...
  render() {
    ...
    console.log(this.state.option,'refundoption');
    let get_file_path,
      dis_file_path = [],
      item_file_path = [],
      attach_file_path,
                          ...
                          <div className="w-100 res-sm-mt-0">
                            <input
                              ...
                              onChange={(e) => {
                                ...
                                console.log(this.state.amount_of_payment)
                        ...
                        <div id="discount" className="tab-pane fade in active">
                          <form className="custom-form mh row">
                            ...
                            <div className="col-md-12 col-xs-12 text-right">
                              ...
                              <button className='btn btn-green mar-rgt-5 btn-align' type="button" onClick={() => { this.addDiscount() }} >Ok</button>
                        ...
                        <div id="credits" className="tab-pane fade in">
                          <div className="clearfix">
                            ...
                            <div className="col-md-6 text-right pad-no">
                              <button className="btn btn-lightgray btn-align">
                                Clear
                              </button>
                            </div>
                          </div>
                          ...
                          <div className="clearfix">
                            ...
                            <div className="col-md-12 text-right pad-no">
                              <button className="btn btn-lightgray btn-align" onClick={() => jQuery('.discount-wrap').slideToggle()}>
                                Cancel
                              </button>
                              <button className="btn btn-green btn-align" onClick={() => {
                                this.applyCredit()
                                jQuery('.discount-wrap').slideToggle()
                              }
                              }>Ok</button>
                        ...
                        <div className='form-group col-md-12 col-xs-12 pad-no mar-b-no'>
                          ...
                          <label className='custom-checkbox radio mar-b-no'>
                            <input
                              type='radio'
                              name='over'
                              checked={this.state.option == 4 || this.state.option=='4' ? true : false}
                              onClick={() => {
                    ...
                    <div class="modal-body text-center">
                      ...
                      <form class="custom-form row column">
                        ...
                        <div class="form-group col-md-12 col-xs-12 mh btn-sec text-right mar-b-no">
                          <button class="btn btn-lightgray btn_align"  data-dismiss="modal"  type="button">
                            Cancel
                          </button>
                          {"   "}
                          <button
                            class="btn btn-green btn_align"
                            type="button"
                            onClick={() => {
                    ...
                    <div className="modal-body text-center">
                      ...
                      <form className="custom-form row column">
                        ...
                        <div className="form-group col-md-12 col-xs-12 mh btn-sec text-center mar-b-no">
                          <button className="btn btn-lightgray mar-rgt-5 btn-align" data-dismiss="modal">Cancel</button>
                          <input type="button" className="btn btn-green mar-rgt-5 btn-align" value="Submit" onClick={() => {
                    ...
                    <div class="modal-body text-center">
                      ...
                      <form class="custom-form row column">
                        ...
                        <div class="form-group col-md-12 col-xs-12 mh btn-sec text-center mar-b-no">
                          <button
                            class="btn btn-lightgray btn-align"
                            type="button"
                            data-dismiss="modal"
                          >
                            Cancel
...
export default Customer_receive_payment;
