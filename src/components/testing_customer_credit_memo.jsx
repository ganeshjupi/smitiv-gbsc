...
class Testing_customer_credit_memo extends React.Component {
    constructor(props) {
        super(props);
    ...
    saveAsPdf = () => {
        ...
        FetchAllApi.save_sales_invoice_as_pdf(Input, (err, response) => {
    ...
    componentDidMount() {
        ...
        this.Basic_info(this.state.customer_id);
        console.log(this.state.customer_id,this.state.customerID);
        ...
        this.groupRequestAppendInvoice();
    }
...
export default Testing_customer_credit_memo;