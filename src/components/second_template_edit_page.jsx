...
export class Template_edit_page extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            html_content: (this.props.location.state && this.props.location.state.html_content) ? this.props.location.state.html_content : `<div style="color:#6A6A6A;background:#fff;min-height:98%;border:1px solid #c7c7c7;width:95%;margin:0 auto;font-size:20px;display:block;overflow:hidden; box-sizing: border-box;">
            ...
            <div style="float:left;width:100%;padding:25px; box-sizing: border-box;">
                <div id="isLogo" style="float:left;display:flex;align-items:center;">
                    <img id="image" style="width:100px" src="" alt="logo"/>
                </div>
...
INVOICE</span >
            ...
            <div style="float:left;width:100%;padding:25px 25px 0px 25px ;  box-sizing: border-box;">
                <div style="border:1px solid #bababa;float:left;width:100%; box-sizing: border-box;">
                   <div id="headDiv" style="float:left;width:100%;">
                       <div style="float:left;width:25%;border-right:1px solid #bababa;border-bottom:1px solid #bababa ;padding:15px; box-sizing: border-box;">
                           <p style="margin-bottom:0;font-weight:600;">Invoice No</p>
                           <p id="p-invoice_number" style="margin-bottom:0;">Inv-10</p>
                       </div>
                       <div style="float:left;width:25%;border-right:1px solid #bababa;border-bottom:1px solid #bababa ;padding:15px; box-sizing: border-box;">
                           <p style="margin-bottom:0;font-weight:600;">Invoice Date</p>
                           <p id="p-invoice_date" style="margin-bottom:0;">01-01-2021</p>
                       </div>
                       <div style="float:left;width:25%;border-right:1px solid #bababa;padding:15px;border-bottom:1px solid #bababa ; box-sizing: border-box;">
                           <p style="margin-bottom:0;font-weight:600;">Due date</p>
                           <p id="p-due_date" style="margin-bottom:0;">01-01-2021</p>
                       </div>
                       <div style="float:left;width:25%;border-bottom:1px solid #bababa ;padding:15px; box-sizing: border-box;">
                           <p style="margin-bottom:0;font-weight:600;">Invoice Currency</p>
                           <p id="p-foreign_currency" style="margin-bottom:0;">SGD</p>
                       </div>
                       <div style="border-bottom:1px solid #bababa;float:left;width:25%;padding:15px; border-right:1px solid #bababa ; box-sizing: border-box;">
                           <p style="margin-bottom:0;font-weight:600;">Job Name</p>
                           <p id="p-job_name" style="margin-bottom:0;">Name</p>
                       </div>
                       <div style="border-bottom:1px solid #bababa;float:left;width:25%;padding:15px; box-sizing: border-box; border-right:1px solid #bababa;">
                           <p style="margin-bottom:0;font-weight:600;">Memo</p>
                           <p id="p-memo" style="margin-bottom:0;">Memo</p>
                       </div>
                       <div style="border-bottom:1px solid #bababa;float:left;width:25%;padding:15px; box-sizing: border-box; border-right:1px solid #bababa;">
                       <p style="margin-bottom:0;font-weight:600;">Exchange Rate</p>
                       <p id="p-exchange_rate" style="margin-bottom:0;">1.00</p>
                       </div>
                       <!-- custom header fields -->

                       <div style="border-bottom:1px solid #bababa;float:left;width:25%;padding:15px; box-sizing: border-box; border-right:1px solid #bababa;display:none" id="customField0">
                       <p id="customFieldName0" style="margin-bottom:0;font-weight:600;">field 1</p>
                       <p id="head-0" style="margin-bottom:0;">[field value]</p>
                       </div>
                       <div style="border-bottom:1px solid #bababa;float:left;width:25%;padding:15px; box-sizing: border-box; border-right:1px solid #bababa;display:none" id="customField1">
                       <p id="customFieldName1" style="margin-bottom:0;font-weight:600;">field 2</p>
                       <p id="head-1" style="margin-bottom:0;">[field value]</p>
                       </div>
                       <div style="border-bottom:1px solid #bababa;float:left;width:25%;padding:15px; box-sizing: border-box; border-right:1px solid #bababa;display:none" id="customField2">
                       <p id="customFieldName2" style="margin-bottom:0;font-weight:600;">field 3</p>
                       <p id="head-2" style="margin-bottom:0;">[field value]</p>
                       </div>
                       <div style="border-bottom:1px solid #bababa;float:left;width:25%;padding:15px; box-sizing: border-box; border-right:1px solid #bababa;display:none" id="customField3">
                       <p id="customFieldName3" style="margin-bottom:0;font-weight:600;">field 4</p>
                       <p id="head-3" style="margin-bottom:0;">[field value]</p>
                       </div>
                       <div style="border-bottom:1px solid #bababa;float:left;width:25%;padding:15px; box-sizing: border-box; border-right:1px solid #bababa;display:none" id="customField4">
                       <p id="customFieldName4" style="margin-bottom:0;font-weight:600;">field 5</p>
                       <p id="head-4" style="margin-bottom:0;">[field value]</p>
                       </div>
                       <div style="border-bottom:1px solid #bababa;float:left;width:25%;padding:15px; box-sizing: border-box; border-right:1px solid #bababa;display:none" id="customField5">
                       <p id="customFieldName5" style="margin-bottom:0;font-weight:600;">field 6</p>
                       <p id="head-5" style="margin-bottom:0;">[field value]</p>
                       </div>
                       <div style="border-bottom:1px solid #bababa;float:left;width:25%;padding:15px; box-sizing: border-box; border-right:1px solid #bababa;display:none" id="customField6">
                       <p id="customFieldName6" style="margin-bottom:0;font-weight:600;">field 7</p>
                       <p id="head-6" style="margin-bottom:0;">[field value]</p>
                       </div>
                       <div style="border-bottom:1px solid #bababa;float:left;width:25%;padding:15px; box-sizing: border-box; border-right:1px solid #bababa;display:none" id="customField7">
                       <p id="customFieldName7" style="margin-bottom:0;font-weight:600;">field 8</p>
                       <p id="head-7" style="margin-bottom:0;">[field value]</p>
                       </div>
                       <div style="border-bottom:1px solid #bababa;float:left;width:25%;padding:15px; box-sizing: border-box; border-right:1px solid #bababa;display:none" id="customField8">
                       <p id="customFieldName8" style="margin-bottom:0;font-weight:600;">field 9</p>
                       <p id="head-8" style="margin-bottom:0;">[field value]</p>
                       </div>
                       <div style="float:left;width:25%;padding:15px; box-sizing: border-box; border-right:1px solid #bababa;display:none" id="customField9">
                       <p id="customFieldName9" style="margin-bottom:0;font-weight:600;">field 10</p>
                       <p id="head-9" style="margin-bottom:0;">[field value]</p>
                       </div>
            ...
            <div style="float:left;width:100%;padding:25px; box-sizing: border-box;">
                ...
                <div id="headDiv1" style="float:left;width:100%;">
                    <div style="float:left;width:45%;">
                        <p style="margin-bottom:8px;font-weight:600;">Invoice to</p>
                        <p id="p-company_address">Blk 194, Pandan Loop #02-17, Pantech Ind Complex Singapore 128383, Singapore</p>
                    </div>
                ...
                <!-- Table Starts here -->
                <div id="itemDiv">
                <table style="width:100%;float:left;margin-top:25px;border-collapse: collapse;box-sizing: border-box;">
                    <thead id="thead" style="background:#5e5e5e;border:1px solid #5e5e5e; box-sizing: border-box;">
                        <tr style="color:#fff;font-weight:500;">
                            <td style="padding:12px 8px; box-sizing: border-box;">Description</td>
                            <td id="isPrice" style="padding:12px 8px; box-sizing: border-box;display:none">Price Each</td>
                            <td id="isQty" style="padding:12px 8px; box-sizing: border-box;display:none">Qty</td>
                            <td id="isTax" style="padding:12px 8px; box-sizing: border-box;display:none">Tax</td>

                            <td style="padding:12px 8px;text-align:center; box-sizing: border-box;" colspan="2">
                            Amount<br/>
                            <span style="float:left;width:50%;font-size:20px;padding:7px 5px 0 5px; box-sizing: border-box;">Debit</span>
                            <span style="float: left;width: 50%;font-size: 20px;padding: 7px 5px 0 5px; box-sizing: border-box;">Credit</span>
                            </td>
                        </tr>
                    </thead>
                    <tbody style="border:1px solid #BABABA; box-sizing: border-box;">
                        <tr id="row-1" style="display:table-row">
                            <td id="row-1-2" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">Lorem ipsum dolor sit amet</td>
                            <td id="row-1-3" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-1-4" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-1-5" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-1-7" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                            <td id="row-1-8" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                        </tr>
                        <tr id="row-2" style="display:table-row">
                            <td id="row-2-2" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">Duis aute irure dolor in repreh</td>
                            <td id="row-2-3" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-2-4" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-2-5" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-2-7" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                            <td id="row-2-8" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                        </tr>
                        <tr id="row-3" style="display:table-row">
                            <td id="row-3-2" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">Excepteur sint occaecat cupidat</td>
                            <td id="row-3-3" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-3-4" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-3-5" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-3-7" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                            <td id="row-3-8" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                        </tr>
                        <tr id="row-4" style="display:none" >
                            <td id="row-4-2" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">Excepteur sint occaecat cupidat</td>
                            <td id="row-4-3" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-4-4" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-4-5" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-4-7" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                            <td id="row-4-8" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                        </tr>
                        <tr id="row-5" style="display:none">
                            <td id="row-5-2" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">Excepteur sint occaecat cupidat</td>
                            <td id="row-5-3" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-5-4" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-5-5" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-5-7" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                            <td id="row-5-8" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                        </tr>
                        <tr id="row-6" style="display:none">
                            <td id="row-6-2" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">Excepteur sint occaecat cupidat</td>
                            <td id="row-6-3" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-6-4" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-6-5" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-6-7" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                            <td id="row-6-8" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                        </tr>
                        <tr id="row-7" style="display:none">
                            <td id="row-7-2" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">Excepteur sint occaecat cupidat</td>
                            <td id="row-7-3" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-7-4" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-7-5" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-7-7" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                            <td id="row-7-8" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                        </tr>
                        <tr id="row-8" style="display:none">
                            <td id="row-8-2" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">Excepteur sint occaecat cupidat</td>
                            <td id="row-8-3" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-8-4" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-8-5" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-8-7" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                            <td id="row-8-8" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                        </tr>
                        <tr id="row-9" style="display:none">
                            <td id="row-9-2" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">Excepteur sint occaecat cupidat</td>
                            <td id="row-9-3" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-9-4" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-9-5" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-9-7" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                            <td id="row-9-8" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                        </tr>
                        <tr id="row-10" style="display:none">
                            <td id="row-10-2" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">Excepteur sint occaecat cupidat</td>
                            <td id="row-10-3" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-10-4" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-10-5" style="font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;">0.00</td>
                            <td id="row-10-7" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                            <td id="row-10-8" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                        </tr>
                        
                        <tr id="row-total" style="border-top:1px solid #bababa;box-sizing: border-box;">
                            <td id="row-total-1" style="border-top:1px solid #bababa;border-bottom:1px solid #bababa;font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;font-weight:600; box-sizing: border-box;">Total Amount</td>
                            <td id="total-3" style="border-top:1px solid #bababa;border-bottom:1px solid #bababa;font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;"></td>
                            <td id="total-4" style="border-top:1px solid #bababa;border-bottom:1px solid #bababa;font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;"></td>
                            <td id="total-5" style="border-top:1px solid #bababa;border-bottom:1px solid #bababa;font-size: 20px;display:none;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px; box-sizing: border-box;"></td>
                            <td id="row-total-2" style="border-top:1px solid #bababa;border-bottom:1px solid #bababa;font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                            <td id="row-total-3" style="font-size: 20px;border-left:1px solid #bababa;border-right:1px solid #bababa;border-top:1px solid #bababa;border-bottom:1px solid #bababa;padding:12px 8px;text-align:center; box-sizing: border-box;">0000.00</td>
                        </tr>
                    </tbody>
                </table>
                </div>
            ...
            <p id="p-thanking_message" style="margin-top: 0; margin-bottom: 15px">Thank you message and Banking details</p>
             ...
             <div style="float:left;width:100%;">            
                    ...
                    <p id="p-terms_and_conditions" style="font-size:20px;">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore</p>
                </div>
            </div>
    ...
    handlechange() { 
        ...
        this.setState({html_content: `<div style="color:#6A6A6A;background:#fff;min-height:98%;border:1px solid #c7c7c7;width:95%;margin:0 auto;font-size:20px;display:block;overflow:hidden; box-sizing: border-box;">
        <!-- Template Header Starts here -->
        <div style="float:left;width:100%;padding:25px; box-sizing: border-box;">
            <div id="isLogo" style="float:left;display:flex;align-items:center;">
                <img id="image" style="width:100px" src="" alt="logo"/>
