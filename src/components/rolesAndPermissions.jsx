      ...
      <React.Fragment>
        <div>
          ...
          {/* <div className='invoice-form'>
            <div class="pf-btm-wrap">
              <div class="col-md-6 col-sm-6 col-xs-12 pad-no">
                <button class="btn btn-empty ico">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12 text-right pad-no">
                <button class="btn btn-lightgray mar-rgt-5">Close</button>
                <button class="btn btn-yellow mar-rgt-5">Save & New</button>
                <button class="btn btn-green mar-rgt-5">Save</button>
              </div>
            </div>
          </div> */}
