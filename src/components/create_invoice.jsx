...
import { isNaN, lowerFirst } from "lodash";
import parse from 'html-react-parser'
...
class invoice_template_listing extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      total_avail: 0,
      total_used_credit: 0,
      total_remain_credit: 0,
      selected_due_date: '',
      is_void:false,
      // customField: [
      //   { type: 'text', name: 'text field 1', options: [], key: '', value: '10' },
      //   { type: 'dropdown', name: 'dropdown field 1', options: [], key: '', value: '20' },
      //   { type: 'date', name: 'date field 1', options: [], key: '', value: '30' }
      // ],
      customFields: '',
      values: [],
      //       html_contents :      `<div
      ...
      //           "
      //         >
      //         <img id="image" style="max-width:100%;max-height:100%;" src="" alt="logo"/>
      //         </div>
      ...
      //            <p id="isGstNumber" style="margin-bottom: 0 ;display: block">[GST registration number]</p>
      //         </div>
      //       </div>
      ...
      //                 <span style="font-weight: 600">Invoice No:</span>100230
      //               </p>
      //               <p style="margin-bottom: 0">
      //                 <span style="font-weight: 600">Date:</span> 10 May 2021
      //               </p>
      //               <p style="margin-bottom: 0">
      //                 <span style="font-weight: 600">Duedate:</span> 18 May 2021
      //               </p>
      //             </div>
      //             <div style="float: left; width: 100%">
      //               <div style="float: left; width: 20%">
      //                 <p style="margin-bottom: 8px; font-weight: 600">Invoice Currency</p>
      //                 <p>[Your invoice currency]</p>
      //               </div>
      //               <div style="float: left; width: 20%">
      ...
      //                     <tr>
      //                     <td style="font-size:13px;padding:12px 8px;box-sizing:border-box;">01</td>
      //                     <td style="font-size:13px;padding:12px 8px;box-sizing:border-box;">Lorem ipsum dolor sit amet</td>
      //                     <td style="font-size:13px;padding:12px 8px;box-sizing:border-box;">00.00</td>
      //                     <td style="font-size:13px;padding:12px 8px;text-align:center;box-sizing:border-box;">00</td>
      //                     <td style="font-size:13px;padding:12px 8px;text-align:center;box-sizing:border-box;">0.0%</td>
      //                     <td style="font-size:13px;padding:12px 8px;text-align:center;box-sizing:border-box;">00.00</td>
      //                     </tr>
      //                     <tr>
      //                         <td style="font-size:13px;padding:12px 8px;box-sizing:border-box;">02</td>
      //                         <td style="font-size:13px;padding:12px 8px;box-sizing:border-box;">Lorem ipsum dolor sit amet</td>
      //                         <td style="font-size:13px;padding:12px 8px;box-sizing:border-box;">00.00</td>
      //                         <td style="font-size:13px;padding:12px 8px;text-align:center;box-sizing:border-box;">00</td>
      //                         <td style="font-size:13px;padding:12px 8px;text-align:center;box-sizing:border-box;">0.0%</td>
      ...
      //                         </tr>
      //                         <tr>
      //                             <td style="font-size:13px;padding:12px 8px;box-sizing:border-box;">03</td>
      //                             <td style="font-size:13px;padding:12px 8px;box-sizing:border-box;">Lorem ipsum dolor sit amet</td>
      //                             <td style="font-size:13px;padding:12px 8px;box-sizing:border-box;">00.00</td>
      //                             <td style="font-size:13px;padding:12px 8px;text-align:center;box-sizing:border-box;">00</td>
      //                             <td style="font-size:13px;padding:12px 8px;text-align:center;box-sizing:border-box;">0.0%</td>
      ...
      //             <p style="margin-top: 0; margin-bottom: 15px">Thank you message and Banking details</p>
      //             <div style="float: left; width: 100%">
  ...
  temChanged = async(id) => {
    ...
    this.setState({ customField, customFieldB, html_contents: obj && obj.html_content },()=>{return true;})
    console.log('temchanged',this.state.html_contents);
  }
  ...
  changeDueDate = (type, invoice_date) => {

    let days = type == 1 ? 0 : type == 2 ? 7 : type == 3 ? 30 : type == 4 ? 60 : type == 5 ? 90 : 0
    jQuery('#due_date').val(moment(invoice_date, 'DD/MM/YYYY').add(days, 'days').format('DD/MM/YYYY'))

    // switch (type) {  0 7 30 60 90
    //   case '1':
    //     { jQuery('#due_date').value(moment(invoice_date, 'DD/MM/YYYY').add(0, 'days').format('DD/MM/YYYY')) } break
    //   case '2':
    //     { jQuery('#due_date').value(moment(invoice_date, 'DD/MM/YYYY').add(0, 'days').format('DD/MM/YYYY')) } break
    //   case '3':
    //     { jQuery('#due_date').value(moment(invoice_date, 'DD/MM/YYYY').add(0, 'days').format('DD/MM/YYYY')) } break
    ...
    //     { jQuery('#due_date').value(moment(invoice_date, 'DD/MM/YYYY').add(0, 'days').format('DD/MM/YYYY')) } break
    //   default:
    //     { jQuery('#due_date').value(moment(invoice_date, 'DD/MM/YYYY').add(0, 'days').format('DD/MM/YYYY')) }
  ...
  // to apply credit api call

  apply_credit_to_invoice = () => {

    if (this.state.credit_list) {

      let Input = {
        client_id: this.state.logged_client_id,
        credit_list: this.state.credit_list,
        customer_id: this.state.selectCustomer,
        job_id: this.state.job_id ? this.state.job_id : this.state.JobId ? this.state.JobId : '',
        invoice_id: this.state.invoice_id_used,
      }

      FetchAllApi.customer_apply_credit(Input, (err, response) => {
        if (response.status === 1) {
          alert(response.message)
          setTimeout(() => {
      ...
      alert('please apply atleast one credit to invoice')
    }
  ...
  // apply credit onchange

  credit_onchange = (i, available_credits) => {
    let total = 0
    let total_used_credit = 0
    let credit_list = []

    // for individual row
    total = total + (this.state[`credit_to_be_use${i}`] ? Number(this.state[`credit_to_be_use${i}`]) : 0)
    // for individual row

    // for table total
    this.state.customer_credit_list && this.state.customer_credit_list.map((item, j) => {
      total_used_credit = total_used_credit + (this.state[`credit_to_be_use${j}`] ? Number(this.state[`credit_to_be_use${j}`]) : 0)
      if (this.state[`credit_to_be_use${j}`] && this.state[`credit_to_be_use${j}`] > 0) {
        let list_obj = { credit_id: item.credit_id, credit_amount: this.state[`credit_to_be_use${j}`] }
        credit_list.push(list_obj)
      }
    })
    // for table total

    this.setState({ [`usedCreditsRowTotal${i}`]: available_credits - total, total_used_credit, credit_list })
  }
  ...
  checkPassword = () => {
    ...
    FetchAllApi.verify_lock_date_password(Input, (err, response) => {
      if (response.status === 1) {
        ...
        setTimeout(
          () => {
            let invoice_date = jQuery('#invoice_date').val()
            if (invoice_date != undefined) {
              this.changeDueDate(this.state.selected_due_date, invoice_date)
            }
  ...
  checkPassword_1 = () => {
    ...
    FetchAllApi.verify_lock_date_password(Input, (err, response) => {
      if (response.status === 1) {
        let temp_date = this.state.temp_date_1
        jQuery('#payment_date').val(temp_date)

        window.jQuery("#asking_password_for_delete_1").modal("hide");
        ...
        setTimeout(
          () => {
            ...
            var date_formated
            let date = jQuery("#payment_date").val();
            ...
            let res = nope.concat(this.state.CurrentSelectedCurr);
            fetch(res)
              .then((response) => response.json())
              .then(async (data) => {

                // same func
                // let newObj = await this.rename(data.quotes, this.state.CurrentSelectedCurr)
                let newObj = {}
                Object.keys(data.quotes).map((key) => {
                  let newKey = key.replace(this.state.CurrentSelectedCurr, '')
                  Object.assign(newObj, { [newKey]: data.quotes[key] })
                })
                // same func

                let value = (newObj[this.state.clientHomeCurrency]).toFixed(4)
                jQuery("#payment_exchange_rate").val(value)
  ...
  changefromDate_1() {
    ...
    let date = this.state.temp_date_1
  ...
  frontPrint = (type) => {
   ...
   // if (this.state.selected_template_type && this.state.selected_template_type == 1) {
    ...
    let invoice_id = this.state.invoice_id_used
    ...
    if (type === "frontprint") {
      ...
      FetchAllApi.send_invoice_mail(data, (err, response) => {
  ...
  groupAcc =  (inv_id, group_accounting_list_id) => {
    ...
    FetchAllApi.getInvoiceDetails(coreData,async (err, response) => {
      console.log(response.status,'groupacc get invoice');
      if (response.status === 1) {
        var primaryData = response.invoice_details;
        this.setState({ invoice_details: response, invoice_details2: response, invoice_id_used: primaryData.id })
        this.customValuesUpdate(primaryData.custom_header_fields, primaryData.custom_footer_fields)      
        await this.temChanged(primaryData.template_id)
          ...
          let cc =  response.invoice_details.invoice_details;
          console.log(cc);
          ...
          dd.map(row => {
            if (cc && cc.length >= row) {
              ...
              jQuery("#row-" + row + "-" + 4).html(cc[row - 1].quantity)
              jQuery("#row-" + row + "-" + 5).html(cc[row - 1].tax_name == "Choose " ? "--" : cc[row - 1].tax_name)
              jQuery("#row-" + row + "-" + 6).html(rowTotal)
              if (rowTotal < 0) {
                jQuery("#row-" + row + "-" + 7).html(rowTotal)
                jQuery("#row-" + row + "-" + 8).html('--')
                subDebit = subDebit + rowTotal
              } else {
                jQuery("#row-" + row + "-" + 7).html('--')
                jQuery("#row-" + row + "-" + 8).html(rowTotal)
                subCredit = subCredit + rowTotal
              }
            } else {
              jQuery("#row-" + row).css("display", "none")
          ...
          jQuery("#row-total-2").html(subDebit)
          jQuery("#row-total-3").html(subCredit)



          let bb = this.state.entity_details && this.state.entity_details.data && this.state.entity_details.data[0]
          console.log(bb,this.state.entity_details.data[0],this.state.entity_details && this.state.entity_details.data && this.state.entity_details.data[0]);
          if(bb){
          jQuery("#isEntityName").html(bb.name)
          jQuery("#isAddress").html(bb.address)
          jQuery("#isPhoneNumber").html(bb.phone)
          ...
          console.log(bb.length,jQuery("#isEntityName").val(),jQuery("#row-total-2").val())
         // let aa = response.invoice_details.invoice_details
          let aa = response.invoice_details
          console.log(aa)
          if(aa){
          jQuery("#p-company_address").html(aa.company_address)
          jQuery("#p-shipping_address").html(aa.shipping_address)
  ...
  saveAsPdf = () => {
    ...
    FetchAllApi.print_pdf(Input, 'create_invoice', (err, response) => {
      if (response.status === 1) {
  ...
  handleCheck_get_selected_tax(
    ...
    // console.log("selectednow_id", selectednow_id);
  ...
  handleChangeItems = async (currid = '', itemid = '') => {
    ...
    // alert(itemid)
    // console.log("itemid", currid);

    var salesarray=this.state.mysalesarray;
    var estimatearray=this.state.myestimatearray;
    var result = [];
    var itemprice = [];
    var subTotal = 0;
    var tax_total = 0;
    ...
    for (var i = itemid; i >= 0; i--) {
      ...
      if (document.getElementById("selectednow_id" + i) != null) {
        ...
        // console.log("itm check", jQuery("#item" + i).val())
        var item_name =
      ...
      if (!this.state.isChecked) {
        ...
        // console.log("item_list1111", result);
      } else {
        if (
      ...
      usedquanity && usedquanity.length!=0 && usedquantity.push({"usedquantity": quantity})
      if(salesarray && salesarray.length>0) 
      {salesarray[i].used_quanity=quantity;}
      if(estimatearray && estimatearray.length>0) 
      {estimatearray[i].used_quanity=quantity;}
        ...
        try {
          {
            ...
            // same func
            // let newObj = await this.rename(data.quotes, foreign_currency)
            ...
            this.setState(
              {
                ...
                mysalesarray:salesarray, 
                myestimatearray:estimatearray,            
  ...
  get_invoice_list = () => {
    let input = { client_id: this.state.logged_client_id, user_id: this.state.logged_user_id, selected_template_type: 1 }
    FetchAllApi.get_edit_invoice_html(input, (err, response) => {
      // console.log("defaultcatejhwdjkjhgorylist", response);
      if (response.status === 1) {
        this.setState({ response: response, template_id: response.default_template_id });
  ...
  get_currencies = () => {
    ...
    fetch(
      ...
      .then(async (data) => {
        ...
        // let newObj =await this.rename(data.quotes, this.state.clientHomeCurrency)
        // same func

        let newObj = {}
        Object.keys(data.quotes).map((key) => {
          let newKey = key.replace(this.state.clientHomeCurrency, '')
          Object.assign(newObj, { [newKey]: data.quotes[key] })
        })
        // same func
  ...
  paymentDateExchangeRate = () => {
    ...
    fetch(res)
      ...
      .then(async (data) => {
        ...
        // same func
        let value = newObj[this.state.clientHomeCurrency] && (newObj[this.state.clientHomeCurrency]).toFixed(4)
        jQuery("#payment_exchange_rate").val(value)
  ...
  async componentDidMount() {
    ...
    FetchAllApi.get_data(this.state.logged_client_id, (err, response) => {
      if (response.status === 1) {
        ...
        console.log(this.state.entity_details);
      }
    })
    ...
    // window.jQuery('#asking_password_for_delete').modal('show')
    ...
    // window.addEventListener('click', function (e) {
    // console.log('sdhfgafha', document.getElementById('mytable'))
    //   if (document.getElementById('mytable').contains(e.target)) {
    //     // click inside
    //   } else {
    //     jQuery(".table-responsive").removeAttr("style");
    ...
    jQuery(window).click(function () {
      ...
      jQuery(".add-new,.cus").on("show.bs.dropdown", function () {
        jQuery("#changeTableProps").css("height", "1000px");
      });
    });

    // jQuery('#menucontainer').click(function(event){
    //   jQuery(".add-new").on("show.bs.dropdown", function () {
    //     jQuery("#changeTableProps").css("height", "1000px");
    //   });
    //   // jQuery("#changeTableProps").css("height", "1000px");
    // });
    ...
    // });
    // jQuery(function () {
    //   jQuery(".add-new").on("hidden.bs.dropdown", function () {
    //     jQuery("#changeTableProps").css("height", "auto");
    //   });
    // });
    ...
    // alert("job id " + JobId);
    await this.customerjoblist(afterJobCustomerId);
    await this.setState(
      {
    ...
    if (this.props.location.state != undefined) {
      ...
      if (this.props.location.state.invoicecreditmemo != undefined) {
        ...
        //  jQuery('#variable_pay_type').val(data.vendorName)
        await this.customerjoblist(data.vendorName);
        jQuery("#invoice_date").val(data.date);
        jQuery("#invoice_no").val(data.salesno);
        jQuery("#shipping_to").val(data.salesorderto);
        jQuery("#footer_memo").val(data.memo);
    ...
    if ((localStorage.getItem("change_invoice_sales") != '' && localStorage.getItem("change_invoice_sales") != undefined && localStorage.getItem("change_invoice_sales") != null) || (localStorage.getItem("change_invoice_estimate") != '' && localStorage.getItem("change_invoice_estimate") != undefined && localStorage.getItem("change_invoice_estimate") != null) || (localStorage.getItem("copy_invoice") != '' && localStorage.getItem("copy_invoice") != undefined && localStorage.getItem("copy_invoice") != null)) {
      setTimeout(() => { this.auto_create_invoice() }, 1000)
    }
  ...
  appendInvoiceDetails = () => {
    ...
    if (setID !== null) {
      ...
      if (localBee.length > 1) {
        ...
        this.setState({ paymentGRTR: Number(payment_id), edited: true });
      } else {
      ...
      if (invoice_id != undefined && invoice_id != "" && invoice_id != null) {
        ...
        FetchAllApi.getInvoiceDetails(coreData, (err, response) => {
          ...
          // alert('rightu') 
          if (response.status === 1) {
            this.setState({ invoice_details: response, invoice_details2: response })
            var primaryData = response.invoice_details;
            this.customValuesUpdate(primaryData.custom_header_fields, primaryData.custom_footer_fields)
            this.temChanged(primaryData.template_id)
            // console.log("kjkkjkkjjjjj", primaryData);
            let paidstaus=primaryData.paid_status ? primaryData.paid_status:"Unpaid"
            jQuery("#paid_status").val(paidstaus + "--invoice");
            ...
            this.setState({ is_void:primaryData.is_voided,invoice_id_used: primaryData.id, payment_desc: primaryData.descripation, template_id: primaryData.template_id, payement_table: response.paymentDetails });
            ...
            for (var kk = 0; kk < useme; kk++) {
              ...
              this.setState(
                {
                  cus_rate_rate: primaryData.exchange_rate,
                },
                () => {
                  this.handleChangeItems("", this.state.rows.length - 1);
                }
  ...
  groupRequestAppendInvoice = () => {
    ...
    if (invoice_id != undefined && invoice_id != "" && invoice_id != null && id != undefined && id != "" && id != null) {
      ...
      // setTimeout(() => {
      FetchAllApi.getGroupInvoiceDetails(coreData, (err, response) => {
        console.log("vendor_names", response);
        // alert('rightu')f
        if (response.status === 1) {
          var primaryData = response.invoice_details;
          ...
          if (payment_id == 0) {
            jQuery("#payable_amount").val(primaryData.payment_amount);
            jQuery("#payment_method option:selected").val()
            jQuery("#payment_method").val(primaryData.payment_method);
            ...
            var date_formated
            let date = moment(primaryData.payment_date).format("DD/MM/YYYY")
            if (date != undefined && date != null && date != '') {
              var array = date.split("/");
              date_formated = array[2] + "-" + array[1] + "-" + array[0];
              nope = `https://api.currencylayer.com/historical?access_key=${config.api_key}&date=${date_formated}&source=`
            ...
            // let nope = "https://api.exchangeratesapi.io/" + date_formated + "?base="
            let res = nope.concat(primaryData.foreign_currency);
            fetch(res)
              .then(async (response) => response.json())
              .then(async (data) => {
                // let newObj = await this.rename(data.quotes, currency)
                // same func

                let newObj = {}
                Object.keys(data.quotes).map((key) => {
                  let newKey = key.replace(primaryData.foreign_currency, '')
                  Object.assign(newObj, { [newKey]: data.quotes[key] })
                })
                // same func
                let value = (newObj[this.state.clientHomeCurrency]).toFixed(4)
  ...
  delete_or_void_sales_invoice = (val) => {
    ...
    FetchAllApi.delete_or_void_sales_invoice(
      input,
      (err, response) => {
        if (response.status === 1) {
          alert(response.message)
  ...
  apply_credit = () => {
    ...
    var client_id = this.state.logged_client_id;
    var customer_id = this.state.selectCustomer
    var job_id = this.state.job_id ? this.state.job_id : this.state.JobId ? this.state.JobId : ''
    var credit_account = jQuery("#account_id").val();
    var multi_payment_applied_invoices = '';
    ...
    FetchAllApi.customer_creditlists(
      ...
      (err, response) => {
        ...
        if (response.status === 1) {
          ...
          // for table total calc
          let total_amt = 0
          let total_avail = 0
          response.response && response.response.map((item, i) => {
            total_amt = total_amt + (item.amount ? Number(item.amount) : 0)
            total_avail = total_avail + (item.available_credits ? Number(item.available_credits) : 0)

          })
          // for table total calc


          this.setState({ customer_credit_list: response.response, credit_available: response.available_credit_foreign_currency, total_amt, total_avail });



          setTimeout(() => {
            window.jQuery('#apply_credit_modal').modal('show')
          }, 500)
        } else {
          alert(response.message)
        }
    ...
    if (
      ...
      if (
        ...
        if (!this.state.isInvoiceEditable || this.state.isInvoiceEditable) {
          ...
          if (payable_amount == "" || payable_amount == undefined) {
            if (val == 'memo') {
              localStorage.setItem("change_memo", JSON.stringify(data))
              window.open("/create_creditmemo");
            } else {
              localStorage.setItem("copy_invoice", JSON.stringify(data))
  ...
  auto_create_invoice = () => {
    ...
    if (localStorage.getItem("change_invoice_sales") != '' && localStorage.getItem("change_invoice_sales") != null && localStorage.getItem("change_invoice_sales") != undefined) {
      primaryData = JSON.parse(localStorage.getItem("change_invoice_sales"))
      this.setState({mysalesarray:primaryData.item_list});
    }
    console.log('change_invoice_sales',primaryData);
    if (localStorage.getItem("change_invoice_estimate") != '' && localStorage.getItem("change_invoice_estimate") != null && localStorage.getItem("change_invoice_estimate") != undefined) {
      primaryData = JSON.parse(localStorage.getItem("change_invoice_estimate"))
      this.setState({myestimatearray:primaryData.item_list});
    }

    if (localStorage.getItem("copy_invoice") != '' && localStorage.getItem("copy_invoice") != null && localStorage.getItem("copy_invoice") != undefined) {
      primaryData = JSON.parse(localStorage.getItem("copy_invoice"))
    }
    console.log('mysalesarray',this.state.mysalesarray);
    console.log('myestimatearray',this.state.myestimatearray);
    let paidstaus=primaryData.paid_status ? primaryData.paid_status:"Unpaid"
    jQuery("#paid_status").val(paidstaus + "--invoice");
    ...
    if (localStorage.getItem("change_invoice_sales") != '' && localStorage.getItem("change_invoice_sales") != null && localStorage.getItem("change_invoice_sales") != undefined) {
      ...
      this.setState({ sales_order_id: primaryData.sales_order_id });
    }
    if (localStorage.getItem("change_invoice_estimate") != '' && localStorage.getItem("change_invoice_estimate") != null && localStorage.getItem("change_invoice_estimate") != undefined) {

      this.setState({ estimate_id: primaryData.estimate_id });
    }
    ...
    if (localStorage.getItem("change_invoice_sales") != '' && localStorage.getItem("change_invoice_sales") != null && localStorage.getItem("change_invoice_sales") != undefined) {
      ...
      localStorage.setItem("change_invoice_sales", "")
    }
    if (localStorage.getItem("change_invoice_estimate") != '' && localStorage.getItem("change_invoice_estimate") != null && localStorage.getItem("change_invoice_estimate") != undefined) {

      localStorage.setItem("change_invoice_estimate", "")
    }
    if (localStorage.getItem("copy_invoice") != '' && localStorage.getItem("copy_invoice") != null && localStorage.getItem("copy_invoice") != undefined) {

      localStorage.setItem("copy_invoice", "")
    }
  ...
  save_template = (e, btn_type) => {
    ...
    if (payable_amount != "" && payable_amount != undefined) {
      ...
      var payment_method = jQuery("#payment_method").val() ? jQuery("#payment_method").val() : 18;// jQuery("#payment_method option:selected").val();
     
      console.log(jQuery("#payment_method option:selected").val())
      if (payment_method != "" && payment_method != undefined) {
        this.setState({ isPaymentMethod: false });
      } else {
        this.setState({ isPaymentMethod: true });
    ...
    let terms_and_conditions = jQuery("#termcondmsg").val();
    let item_list = this.state.myarray;
    let sales_order_item_list=this.state.mysalesarray;
    let estimate_item_list=this.state.myestimatearray;
    let shipping_to = jQuery("#shipping_to").val();
    let company_address = jQuery("#shipping_to").val();
    let footer_memo = jQuery("#footer_memo").val();
    let footer_thankyou = jQuery("#footeroptionthanksmessages").val();
    ...
    var sales_item_incre = "";
    if(this.state.sales_order_id && this.state.sales_order_id!=undefined){
      item_list.map((item_list_data, index) => {
        // console.log("item_list_data", item_list_data);
        // console.log("item_list_data_item_name", item_list_data.item_name);
        var incre = parseInt(index) + 1;
    ...
    if (
      ...
      let data = {
        ...
        tagged_user_id: this.state.logged_user_id,
        item_list: item_list,
        sales_order_item_list:sales_order_item_list,
        estimate_item_list:estimate_item_list,
        // job_name: job_name,
        job_name: job_name,
        memo: jQuery("#footer_memo").val(),
        shipping_address: company_address,
        ...
        descripation: this.state.payment_desc,
        template_id: this.state.template_id,
        due_date_term: this.state.selected_due_date,
        ...
        lock_date_password: this.state.old_password
          ...
          if (payable_amount == "" || payable_amount == undefined) {
            ...
            FetchAllApi.create_sales_invoice(data, (err, response) => {
              ...
              if (response.status === 1) {
                ...
                this.setState({ is_credit_limit_accepted: 0 })

                if (response.group_accounting_list_id && response.group_accounting_list_id != 0) {
                  alert('please wait, pdf is generating for Manual Journal');
                  this.setState({ manualLoading: true })
                  this.groupAcc(response.invoice_id, response.group_accounting_list_id)
                }
                ...
                if (btn_type === "save") {
                  ...
                  alert(response.message)
                  // for pdf print
                  this.setState({ isInvoiceEditable: true, invoice_id_used: response.invoice_id });
                  // for pdf print
                  ...
                  if(response.group_accounting_list_id == undefined || response.group_accounting_list_id == 0) {
  ...
  getNextInvoiceNumber = () => {
    ...
    FetchAllApi.getNextInvoiceNumber(coreData, async (err, response) => {
      // console.log("vendor_names", response);
      // alert('rightu')
      if (response.status === 1) {
        this.setState({ invoice_number_for_print: response.invoice_number, invoice_date_for_print: moment(response.invoice_date).format("DD/MM/YYYY"), selected_due_date: response.due_date_term })
        jQuery("#invoice_no").val(response.invoice_number);
        jQuery("#invoice_date").val(
          moment(response.invoice_date).format("DD/MM/YYYY")
        );
        jQuery("#due_date").val(
          moment(response.invoice_default_due_date).format("DD/MM/YYYY")
        );
        ...
        // alert(response.invoice_number)   payment_date
        // this.setState({ customerjoblist: response.results })
  ...
  render() {
    ...
    // console.log('hfggsdgsdhhhhh', this.state.invoice_id_used)
    // console.log('hfggsdgsdhhhhh111', this.state.credit_list)
    var data = "";
                          ...
                          <select
                            ...
                            onChange={async (e) => {
                              if (
                                ...
                                // To update payment exchange rate
                                ...
                                await fetch(res)
                                  ...
                                  .then(async (data) => {
                                    ...
                                    let newObj = {}
                                    Object.keys(data.quotes).map((key) => {
                                      let newKey = key.replace(currency, '')
                                      Object.assign(newObj, { [newKey]: data.quotes[key] })
                                    })
                                    // same func
                                    let value = (newObj[this.state.clientHomeCurrency]).toFixed(4)
                ...
                <div className="main-content col-md-12 col-xs-12">
                  <div className="content-sec col-md-12 col-xs-12 pad-no mar-t-no">
                    <form className="custom-form invoice-form">
                        ...
                        <div className="form-group col-lg-4 col-md-6 col-sm-6 col-xs-12">
                          ...
                          <select
                            ...
                            onChange={(e) => {
                              ...
                              // to due date term type change
                              let obj = this.state.customer_and_job_list && this.state.customer_and_job_list.filter((i) => i.id == value)
                              let term = (obj != undefined && obj.due_date_term != '') ? obj.due_date_term : 1
                              this.setState({ selected_due_date: term }, () => {
                                setTimeout(() => {
                                  let invoice_date = jQuery('#invoice_date').val()
                                  if (invoice_date != undefined) {
                                    this.changeDueDate(term, invoice_date)
                                  }
                                }, 500);
                              })
                              // to due date term type change
                      ...
                      <converter ref={this.child} />
                        ...
                        >
                          <label>Invoice Date<span className="astrick">*</span></label>
                          {/* <div>
                            <DatePicker
                          ...
                          <div className="input-group date mar-t-no">
                            <input
                              ...
                              required
                            />
                            <div className="input-group-addon" onClick={() => jQuery('#invoice_date').focus()}>
                              <img src="images/calendar-icon.svg" alt="icon" />
                            </div>
                          </div>
                      ...
                      <div className="row">
                        ...
                        <div className="form-group col-md-4">
                          <label>Due date type<span className="astrick">*</span></label>
                          <div className="custom-select-drop dropdown">
                            <select
                              ...
                              onChange={(e) => {
                                let value = e.target.value
                                this.setState({ selected_due_date: value }, () => {
                                  setTimeout(() => {
                                    let invoice_date = jQuery('#invoice_date').val()
                                    if (invoice_date != undefined) {
                                      this.changeDueDate(value, invoice_date)
                                    }
                                  }, 500);
                                })
                              }}
                                ...
                                <div className="form-group col-md-4">
                                  ...
                                  <div className="input-group date mar-t-no">
                                    <input
                                      ...
                                      required
                                    />
                                    <div className="input-group-addon" onClick={() => {
                                      jQuery(`#customField${i}`).focus()
                                    }}>
                                      <img src="images/calendar-icon.svg" alt="icon" />
                                    </div>
                                  </div>
                  ...
                  >
                    ...
                    {this.state.isMobileno ? (
                            ...
                            <div className="modal-body text-center">
                              ...
                              <form className="custom-form row column">
                                ...
                                <div className="form-group col-md-12 col-xs-12 mh btn-sec text-center mar-b-no">
                                  ...
                                  <input type="button" className="btn btn-green mar-rgt-5" data-dismiss="modal" value="Submit" onClick={() => {
                                    if (this.state.old_password !== '') {
                                      this.save_template('', "save")
                                    }
                                  }} />
                                </div>
                              </form>
                            ...
                            <div class="modal-content">
                              <div class="modal-body text-center success-modal">
                                ...
                                <button
                                  ...
                                  type="button"
                                  data-dismiss="modal"
                                  data-toggle="modal" data-target="#asking_password_for_delete_1"
                                // 
                                >
                                  Apply
                                </button>
                      ...
                      <div className="modal fade pop-modal" id="asking_password_for_delete_1" role="dialog">
                        <div className="modal-dialog modal-xs custom-modal">
                          {/* Modal content*/}
                          <button type="button" className="close hidden-xs" data-dismiss="modal">
                            <img className="img-responsive" src="images/close-red.svg" alt="icon" />
                                ...
                                {this.state.rows.map(function (row, index) {
                                  ...
                                  return (
                                    <tr key={row} className="handle">
                                      ...
                                      <td className="Tax_width" onClick={() => jQuery("#changeTableProps").css("height", "1000px")} onBlur={() => jQuery("#changeTableProps").css("height", "1000px")}
                                      ...
                                      <td>
                                        <textarea
                                          ...
                                          id={`descr${itemid}`}
                                          onInput={(event) => {
                                            THIS.handleChangeItems(event, THIS.state.rows.length - 1)
                                          }
                                          }
                                        ></textarea>
                                      </td>
                            ...
                            <div className="form-group exchange-col col-md-5 col-xs-12">
                              ...
                              <div>
                                <input
                                  ...
                                  required
                                  autoComplete="off"
                                  placeholder={Number(this.state.exchange_value_ref).toFixed(4)}
                                ...
                                <table className="pull-right">
                                  ...
                                  <tbody style={{ display: 'none' }}>
                                    <tr style={{ background: "#fff" }}>
                                      ...
                                      <td style={{ cursor:"pointer",textDecorationColor: "#0000ff", textDecoration: "underline", color: "#0000ff" }} id="appliedfor" data-toggle="modal" data-target="#table_items" className="text-center">
                            ...
                            <div className="row">
                              <div className="form-group col-md-4">
                                ...
                                <div className="input-group date">
                                  <input
                                    ...
                                    onBlur={
                                      () => {
                                        ...
                                        setTimeout(() => {
                                          this.setState({ temp_date_1: jQuery('#payment_date').val() })
                                        }, 500);
                                        ...
                                        setTimeout(() => {
                                          if (this.state.lock_date) {
                                            if (jQuery('#payment_date').val()) {
                                              // console.log('ppppp', this.state.lock_date)
                                              let date = this.changefromDate_1()
                                              // console.log('ppppp', date)
                                              if (this.state.lock_date >= date) {
                                                jQuery('#payment_date').val("")
                                                window.jQuery("#lock_date_1").modal("show");
                                                // console.log('ppppp', 'ask password')
                                              } else {
                                                window.jQuery("#lock_date_1").modal("hide");
                                                // console.log('ppppp', 'leave date')
                                              }
                                            }
                                          } else {
                                  ...
                                  />
                                  <div className="input-group-addon" onClick={() => jQuery('#payment_date').focus()}>
                                    <img
                              ...
                              <div className="form-group exchange-col col-md-4 mar-b-no">
                                ...
                                <div className="w-100">
                                  <input
                                    ...
                                    autoComplete="off"
                                    // max='100'
                                    // max={this.state.isInvoiceEditable ? Number(jQuery("#forbaldue").html()) : Number(jQuery("#home_grand_total").html())}
                                    onChange={async (e) => { 
                                      let pre_amt = jQuery('#payable_amount').val()
                                      let amount = e.target.value
                                      // let previous_amt = jQuery('#payable_amount').value = '' ?  jQuery('#payable_amount').value = '' : 
                                      if (!isNaN(e.target.value)) {
                                       
                                        if(pre_amt && pre_amt>0){

                                        }
                                        else{
                                        
                                        // console.log('33333333', pre_amt)
                                        // console.log('333333331', amount)
                                        if (this.state.isInvoiceEditable) {

                                          // to remove comma from amount 
                                          let a = jQuery("#forbaldue").html()
                                          let b = a.split(',')
                                          let c = Number(b.join(''))
                                          // to remove comma from amount 
                                          ...
                                          if (!isNaN(c)) {
                                            if (c >= Number(amount)) {
                                              ...
                                              alert('you cannot pay more than amount due')
                                              jQuery('#payable_amount').val(this.state.amount_entered)
                                            }
                                          }
                                        }
                                        }
                                        if (!this.state.isInvoiceEditable) {
                                          ...
                                          // console.log('333333331', jQuery("#home_grand_total").html())
                                          // console.log('3333333312', Number(jQuery("#home_grand_total").html()))

                                          // to remove comma from amount 
                                          let a = jQuery("#home_grand_total").html()
                                          let b = a.split(',')
                                          let c = Number(b.join(''))
                                          // to remove comma from amount 
...
{this.state.isThirdPartyName && (
                        ...
                        <div className="col-md-6 col-sm-6 col-xs-12 pad-no">
                          ...
                          {this.state.isInvoiceEditable &&
                            <button
                              ...
                              className="btn btn-empty ico"
                              // onClick={this.convertHtmlToPdf.bind(this)}
                              onClick={() => this.frontPrint("frontprint")}
                            >
                              <img src="images/pdf-icon.svg" alt="icon" />
                              {/* Front Print */}
                              Save as PDF
                          ...
                          {this.state.isInvoiceEditable &&
                            <>
                              ...
                              <ul className="dropdown-menu category">
                                <li><a onClick={() => { this.autoChangeMemo("copy") }}  >Create a copy</a></li>
                                <li><a data-toggle="modal" data-target="#modal_delete_invoice"
                                //  onClick={
                                //   () => {

                                //   // this.delete_or_void_sales_invoice(10)
                                // }

                                // } 
                                >Delete</a></li>
                                <li><a data-toggle="modal" data-target="#modal_void_invoice"
                                // onClick={() => this.delete_or_void_sales_invoice(11)} 
                                >Void</a></li>
                                <li><a
                                  onClick={() => this.apply_credit()}
                                >Apply credit</a></li>
                                <li><a onClick={() => { this.autoChangeMemo("memo") }} >Sales credit</a></li>
                              </ul>
                              <button
                           className="btn btn-green"
                            type="button"
                            onClick={() => {
                              this.frontPrint("email")
                             // window.close()
                            ...
                            this.state.payement_table.map((pay, idx) => {
                              return (
                                <tr>
                                  ...
                                  <td className="text-right"><Comma value={pay.total_payment_foreign_currency} /></td>
          ...
          <div className="modal fade pop-modal" id="apply_credit_modal" role="dialog">
            <div className="modal-dialog modal-md custom-modal" style={{ width: '955px' }}>
              <button
                type="button"
                className="close hidden-xs"
                data-dismiss="modal"
                  ...
                  <div className="clearfix">
                      ...
                      <table className="dis-table">
                        ...
                        <tbody>
                          {this.state.customer_credit_list &&
                            this.state.customer_credit_list.map(
                              (item, i) => {
                                return (
                                  <tr>
                                    <td className='text-center'>
                                    ...
                                    <td className='text-right'>
                                      <input type={Number}
                                        id={`credit_to_be_use${i}`}
                                        name={`credit_to_be_use${i}`}
                                        value={this.state[`credit_to_be_use${i}`]}
                                        onChange={
                                          e => {

                                            if (!isNaN(e.target.value)) {
                                              let pre_amt = jQuery('#credit_to_be_use' + i).val()
                                              let amount = e.target.value
                                              ...
                                              if (this.state.isInvoiceEditable) {
                                                ...
                                                if (!isNaN(c)) {
                                                  if (c >= Number(amount)) {
                                                    ...
                                                    if (Number(amount) > Number(item.available_credits)) {
                                                      alert("You may not pay more than Credit Amount")
                                                    }

                                                    else {
                                                      this.setState({ [`credit_to_be_use${i}`]: amount })
                                                      setTimeout(() => this.credit_onchange(i, item.available_credits), 500)
                                                    }
                                                    // from cus recei pay


                                                    this.setState({
                                                      [`amount_entered_for_credit${i}`]: amount,
                                                    })
                                                  } else {
                                                    alert('you cannot pay more than amount due')
                                                    jQuery('#payable_amount').val(this.state[`amount_entered_for_credit${i}`])
                                                  }
                                                }
                                              }
                                              if (!this.state.isInvoiceEditable) {
                                                ...
                                                if (!isNaN(c)) {
                                                  if (c >= Number(amount)) {
                                                    ...
                                                    this.setState({
                                                      [`amount_entered_for_credit${i}`]: e.target.value,
                                                    })
                                                  } else {
                                                    alert('you cannot pay more than amount due')
                                                    jQuery('#amount_entered_for_credit' + i).val(this.state[`amount_entered_for_credit${i}`])
                                                  }
                                                }
                                              }
                                            }
                          ...
                          <tr>
                            ...
                            <td className='text-right'>{this.state.total_amt}</td>
                            <td className='text-right'>{this.state.total_avail}</td>
                            <td className='text-right'>{this.state.total_used_credit}</td>
                            <td className='text-right'>{this.state.total_avail - this.state.total_used_credit}</td>
                          </tr>
                    ...
                    <div className="col-md-6 pad-no">
                      {/* <em className="info-em">
                        Of all the credits issued to this Customer, only
                        unused credits applicable to this specific
                        invoice are displayed above
                              </em> */}
                    </div>
                    <div className="col-md-6 text-right pad-no">
                      <button type='button' className="btn btn-lightgray" onClick={() => this.apply_credit_to_invoice()}>
                        Apply Credit
                      </button>
                    </div>
                  </div>
                ...
                <div class="modal-content">
                  <div class="modal-body text-center success-modal">
                    ...
                    <button
                      ...
                      onClick={() => this.delete_or_void_sales_invoice(10)}
                    >
                      Delete
                    </button>
                  </div>
