...
class GST_Details extends React.Component {
  ...
  callAPIDATA() {
    ...
    FetchAllApi.filter_column(
      12,this.state.logged_client_id,
          ...
          <div className="row">
            ...
            <div className="main-wrap col-md-12 col-xs-12 pad-r-no">
              <div className="top-bar col-md-12 col-xs-12 pad-r-no">
                ...
                <span className="page-title hidden-xs">GST Detail Report</span>
              ...
              <div className="col-md-12 col-xs-12 mar-top visible-xs">
                ...
                <span className="page-title">GST Detail Report</span>
              </div>
              {/* content-top Starts here */}
              <div className="content-top col-md-12 col-xs-12">
                <h4 className="fw-sbold mar-t-no">GST Detail Report</h4>
                ...
                <div className="row snippet-row">
                    ...
                    <div className="snippet active">
                      <div>
                        ...
                        <span className="value">
                          ...
                          {this.state.fullResponse.total_supplies != undefined
                            ?
                            <Comma value={this.state.fullResponse.total_supplies} />
                  ...
                  <div className="col-md-3 col-sm-6">
                    <div className="snippet">
                      <div>
                        ...
                        <span className="value">
                          {this.state.home_currency_symbol}{" "}
                          {this.state.fullResponse.total_output_tax != undefined
                            ?
                            <Comma value={this.state.fullResponse.total_output_tax} />
                  ...
                  <div className="col-md-3 col-sm-6">
                    <div className="snippet">
                      <div>
                        ...
                        <span className="value">
                          {this.state.home_currency_symbol}{" "}
                          {this.state.fullResponse.total_input_tax != undefined
                            ?
                            <Comma value={this.state.fullResponse.total_input_tax} />
                  ...
                  <div className="col-md-3 col-sm-6">
                    <div className="snippet">
                      <div>
                        <small>Net GST to be Paid</small>
                        <span className="value">
                          {this.state.home_currency_symbol}{" "}
                          {this.state.fullResponse.net_gst_to_paid != undefined
                            ?
                            <Comma value={this.state.fullResponse.net_gst_to_paid} />
                                  ...
                                  <React.Fragment>
                                    {entry.total_amount !== 0 && (
                                      <>
                                        ...
                                        {entry.list &&
                                          entry.list.map((sub, i) => {
                                            return (
                                              <React.Fragment>

                                                <tr class="item-step1 sub-title">
                                                  <td style={{
                                                    paddingLeft: '45px', position: "sticky",
                                                    left: "0.25rem"
                                                  }}>
                                                  ...
                                                  sub.categories.map((cat, j) => {
                                                    return (
                                                      <React.Fragment>
                                                        ...
                                                        <tr class="item-step1 sub-title">
                                                          <td style={{
                                                            paddingLeft: '90px', position: "sticky",
                                                            left: "0.25rem",backgroundColor: "#EFEFFF"
                                                          }}>
                                                          ...
                                                          cat.invoices.map((inv, k) => {
                                                            return (
                                                              ...
                                                              <tr class="item-step1">
                                                                ...
                                                                <td><span> {inv.type}</span></td>
                                                                <td><span> {inv.transaction_date}</span></td>
                                                                <td><span> {inv.num}</span></td>
                                                                <td><span> {inv.name}</span></td>
                                                                <td><span> {inv.memo}</span></td>
                                                                <td><span> {inv.account}</span></td>
                                                                <td><span> {inv.split}</span></td>
                                                                <td><span>  <Comma value={inv.amount} /> </span></td>
                                                                <td><span>  <Comma value={inv.balance} /> </span></td>
                                                                <td><span>  {inv.currency}  </span></td>
                                                                <td><span>  {inv.exchange_rate}  </span></td> 
                                                                 <td><span>   <Comma value={inv.foreign_amount} />  </span></td>
                                                                <td><span><Comma value={inv.foreign_balance} />   </span></td>
                                                                {/* <td><span> {inv.tax_code}</span></td> */}
                                                                <td><span></span></td>
                                                                <td><span> {inv.tax_rate}</span></td>
                                                        ...
                                                        <tr class="item-step1 title1 bdr-no">
                                                          ...
                                                          <td>
                                                            <span>  <Comma value={cat.total_amount} />
                                                            </span>
                                                          </td>
                                                        </tr>
                                                ...
                                                <tr class="item-step1 sub-title">
                                                  ...
                                                  <td>
                                                    <div> <Comma value={sub.total_amount} /> </div>
                                                  </td>
                                                </tr>
                                        ...
                                        <tr class="item-step1 title1 bdr-no">
                                          ...
                                          <td>
                                            <span> <Comma value={entry.total_amount} />   </span>
                                          </td>
                                        </tr>
                                      </>
                                    )}
