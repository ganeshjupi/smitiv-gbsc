...
class customer_module extends React.Component {
          ...
          {sub_categories &&
            sub_categories.map((itm, i) => {
              ...
              : Number(invoices.prevoius_closing_balance).toFixed(2)} */}
                            ...
                            <td>
                              <div><Comma value={Object.values(itm)[0].prevoius_closing_balance} /></div>
                            </td>
                            <td>
                              <div> </div>
                            </td>
                            ...
                            <td class="trans" style={{ paddingLeft: 1 }}>
                              <div><Comma value={Object.values(itm)[0].prevoius_closing_foreign_balance} />
  ...
  break = (e1) => {
    ...
    if (
      e1.type == "Home currency adjustment"
    ) {
    ...
    else if(e1.type=="Applied credit memo" || e1.type=="Customer Discount"){
      let arr = [
        e1.customer_id,
    ...
    FetchAllApi.customer_balance_sheet(
      ...
      (err, response) => {
        if (response.status === 1) {
          ...
          this.setState({ response: [], customername: [], tableData: [], resData: [], loading: false })
        }
      }
    )
  }
                                        ...
                                        {this.state.coulmns_head && this.state.coulmns_head !== undefined &&
                                          ...
                                          this.state.coulmns_head.map((item, i) => {
                                            ...
                                            return (<option
                                              ...
                                              selected={statusSelected} >{item.heading_name}</option>)
                                    ...
                                    {entry.is_transactions_available == 1 &&
                                      ...
                                      (
                                        ...
                                        <tr className='title-1'>
                                          <td style={{ position: 'sticky', left: '0.25rem',backgroundColor: "#EFEFFF" }}>{entry.category_name}</td>

                                          {this.state.coulmns_head.map((x, y) => {
                                            if(y == 18){
                                              return <td  className={x.clsname}><Comma value={entry.prevoius_closing_balance} /></td>
                                            }else if(y == 26){
                                              return <td  className={x.clsname}><Comma value={entry.prevoius_closing_foreign_balance} /></td>
                                            }else{
                                              return <td style={{ position: 'sticky', left: '0.25rem',backgroundColor: "#EFEFFF" }} className={x.clsname}>&nbsp;</td>
                                            } 
                                          })}
                                        </tr>
