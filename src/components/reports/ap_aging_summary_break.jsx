...
class un_paid_bills_break extends React.Component {
  constructor(props) {
    super(props);
  ...
  callAPIDATA() {
    ...
    if (urlParams.get("vendor_id") == "") {
      filter_id = this.state.result_array
    }
      ...
      return (
        <React.Fragment>
          ...
          <tr className="item-step1 title1 ">
            ...
            <td className=''>
              <span className="">{i2.total_open_balance}</span>
            </td>
            <td className=''>
              <span className="">{i2.total_amount}</span>
            </td>
            ...
            <td className=''>
              <span className="">{i2.total_open_foreign_balance}</span>
            </td>
            <td className=''>
              <span className="">{i2.total_foreign_amount}</span>
            </td>
        ...
        return (
          <React.Fragment>
            <tr className="item-step1" onDoubleClick={() => { this.break(i2) }}>
              ...
              <td className="">
                <span>{i2.grand_total_home_currency}</span>
              </td>
              <td className="">
              ...
              <td className="">
                <span>{i2.balance_foreign_currency}</span>
              </td>
              <td className="">
                <span>{i2.grand_total_foreign_currency}</span>
              </td>
              {/* <td className="">
