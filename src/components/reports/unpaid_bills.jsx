...
class vendor_balance_detail extends React.Component {
  ...
  filterFilters = (result) => {
    ...
    FetchAllApi.filter_column(
      this.state.all_report_name_id,this.state.logged_client_id, filter_key_names,
  ...
  break = (e1) => {
    ...
    if (e1.type == "Third Party Payment") {
      ...
      win.focus();
    } else if (e1.type == "Vendor credit note") {
  ...
  selected_filters = (e) => {
    ...
    if (result.length > 0) {
      ...
      if (result.includes(7)) { this.setState({ selectedFil: 7 }) }
  ...
  callAPIDATA() {
    ...
    FetchAllApi.filter_column(this.state.all_report_name_id,this.state.logged_client_id, this.state.filter_key_names, (errResponse, filtervalue) => {
      console.log("Fijkjlter Result", filtervalue);
      this.setState({ filtervalue: filtervalue });
    });
    FetchAllApi.unpaid_Bills(
      start_date,
      end_date,
      show_columns,
      ...
      (err, response) => {
        ...
        if (response.status === 1) {
          ...
          console.log('1111111res2', arrayOfElements)
      ...
      return (
        <React.Fragment>
          ...
          <tr className="item-step1 title1 ">
            ...
            <td className=''>
              <span className=""><Comma value={i2.total_open_balance} /></span>
            </td>
            <td className=''>
              <span className=""><Comma value={i2.total_amount} /></span>
            </td>
            ...
            <td className=''>
              <span className=""><Comma value={i2.total_open_foreign_balance} /></span>
            </td>
            <td className=''>
              <span className=""><Comma value={i2.total_foreign_amount} /></span>
            </td>
  ...
  renderItemlist = (itemlist) => {
    let array = itemlist;
    console.log("coming array", array.length);
    if (array) {
      return array.map((i2, b) => {
        // console.log(
        //   "open_balance_home_currency",
        //   i2.open_balance_home_currency
        // );
        ...
        return (
          <React.Fragment>
            <tr className="item-step1" onDoubleClick={() => { this.break(i2) }}>
              ...
              <td className="">
                <span>{i2.trans_date != "" ? i2.trans_date : ""}</span>
              </td>
              <td className="">
              ...
              <td className="">
                <span> <Comma value={i2.open_balance_home_currency} /></span>
              </td>
              <td className="">
                <span> <Comma value={i2.grand_total_home_currency} /></span>
              </td>
              <td className="">
                <span>{i2.currency}</span>
              </td>
              <td className="">
                <span>{i2.exchange_rate}</span>
              </td>
              <td className="">
                <span> <Comma value={i2.balance_foreign_currency} /></span>
              </td>
              <td className="">
                <span> <Comma value={i2.grand_total_foreign_currency} /></span>
              </td>
              {/* <td className="">
              ...
              <td className="">
                <span>{i2.split != "" ? i2.split : ""}</span>
              </td>
              <td className="">
                <span>{i2.aging != "" ? i2.aging : ""}</span>
              </td>
              <td className="">
                <span>{i2.terms != "" ? i2.terms : ""}</span>
              </td>
              <td className="">
                <span>{i2.contact != "" ? i2.contact : ""}</span>
              </td>
              <td className="">
                <span>{i2.postal_code != "" ? i2.postal_code : ""}</span>
              </td>
              <td className="">
                <span>{i2.province != "" ? i2.province : ""}</span>
              </td>
              <td className="">
                <span>{i2.city !== undefined ? i2.city : ""}</span>
              </td>
              <td className="">
                <span>{i2.address}</span>
              </td>
              <td className="">
                <span>{i2.email}</span>
              </td>
              <td className="">
                <span>{i2.phone !== undefined ? i2.phone : ""}</span>
              </td>
              <td className="">
                <span>{i2.vendor_name}</span>
              </td>
              <td className="">
                <span>{i2.fax}</span>
              </td>
              <td className="">
                <span>{i2.type_name}</span>
              </td> */}
            </tr>
          </React.Fragment>
        );
        ...
        return (
          <React.Fragment>
            <tr className="item-step1" onDoubleClick={() => { this.break(e1) }}>
              <td className="">
                <span>{e1.transaction_number != "" ? e1.transaction_number : ""}</span>
              </td>
              <td className="" >
                <span>{e1.type}</span>
              </td>
              <td className="">
                <span>{e1.lastmodified != "" ? e1.lastmodified : ""}</span>
              </td>
              <td className="">
                <span>{e1.lastmodifiedby != "" ? e1.lastmodifiedby : ""}</span>
              </td>
              <td className="">
                <span>{e1.trans_date != "" ? e1.trans_date : ""}</span>
              </td>
              <td className="">
              ...
              <td className="">
                <span>{e1.grand_total_home_currency}</span>
              </td>
              <td className="">
              ...
              <td className="">
                <span>{e1.balance_foreign_currency}</span>
              </td>
              <td className="">
  ...
  render() {
    console.log('hhhm', this.state.all_report_name_id);
          ...
          <div className="row">
            ...
            <div className="main-wrap col-md-12 col-xs-12 pad-r-no">
              ...
              <div className="content-top col-md-12 col-xs-12">
                <h4 className="fw-sbold mar-t-no">Vendor Unpaid Bills</h4>
                      ...
                      <table className="table">
                        ...
                        <tbody>
                            ...
                            this.state.response.finalResponse.map(
                              (primaryObj, i) => {
                                ...
                                if (i != 0) {
                                  ...
                                  // console.log( "iiii", itemlist.length);
                                  if (i !== undefined && (itemlist.length !== 0 || creditslist.length !== 0)) {
                                    return (
                                          ...
                                          <td className=''>
                                            <span className="">
                                              {(new Intl.NumberFormat(this.state.language_code + '-' + this.state.country_sortname,
                                                { style: 'currency', currency: this.state.home_currency }).format(primaryObj.total)).replace(this.state.home_currency_symbol, '')}
                          ...
                          >
                            ...
                            <td className=''>
                              <span className="">
                                {console.log(!isNaN(this.state.response.overall_total_home_open_balance) && this.state.response.overall_total_home_open_balance, this.state.response)}
