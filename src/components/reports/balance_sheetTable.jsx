...
class BalanceSheetTable extends React.Component {
  constructor(props) {
    super(props);
  ...
  changedatevalue(seleteddateformat) {
    ...
    if (seleteddateformat == "ALL") {
      this.setState(
        { start_date: " 1970-01-01", end_date: moment().format("YYYY-MM-DD") },
        () => {
          this.callAPIDATA();
        }
      );
                  ...
                  <div className="col-md-3 col-sm-6">
                    <div className="snippet">
                      <div>
                        ...
                        <span className="value">
                          $ {Number(this.state.total_liabilities).toFixed(2)}
                        </span>
                        <img
                          className="snippet-arrow visible-lg"
                          src="images/snippet-arrow.svg"
                        ...
                        <table className="table">
                          ...
                          <tbody>
                                    ...
                                    >
                                      <span className="text-right">
                                        {index ==
                                          ...
                                          ? isNaN(
                                            Number(this.state.total_assets)
                                          )
                                            ? 0
                                            : Number(
                                              this.state.total_assets
                            ...
                            {Object.values(this.state.balance_sheet_data) &&
                              Object.values(this.state.balance_sheet_data).map(
                                (parentCategory, index) => {
                                  if (parentCategory.account_type == "Equity") {
                                    return (
                                      <>
                                        <tr className="item-step1 sub-title">
                                          <td
