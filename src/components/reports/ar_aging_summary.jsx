...
class ar_aging_summary extends React.Component {
                  ...
                  <React.Fragment key={i}>
                    ...
                    {Object.values(itm)[0].sub_categories && Object.values(itm)[0].sub_categories.length > 0 ? null :
                      <tr className="item-step1 ">
                            ...
                            (amount, indexValue) => {
                              return (
                                <React.Fragment key={indexValue}>
                                  <td onDoubleClick={() => { this.goOthers(down.job_id, down.customer_id, indexValue, down.date_string_array) }}>
                                    <span
                        ...
                        <td onDoubleClick={() => { this.goTotalOtherBreak(down.customer_id, down.job_id) }}>
  ...
  goToOtherBreak(start, end, id, job) {
    ...
    window.open("/ar_aging_transactions?customer_id=" + id + "&job_id=" + job + "&start=" + date1 + "&end=" + date2 + "&range=" + this.state.date_range)
  }
          ...
          <div className="row">
            ...
            <div className="main-wrap col-md-12 col-xs-12 pad-r-no">
              <div className="top-bar col-md-12 col-xs-12 pad-r-no">
                ...
                <span className="page-title hidden-xs">Customer Aging Summary</span>

                <Topbar history={this.props.history} logoutSubmit={(e) => this.logoutLink()} />
              </div>

              <div className="col-md-12 col-xs-12 mar-top visible-xs">
                <span className="page-title">Customer Aging Summary</span>
              </div>
              {/* content-top Starts here */}
              <div className="content-top col-md-12 col-xs-12">
                <h4 className="fw-sbold mar-t-no">Customer Aging Summary</h4>
                          ...
                          <tbody>
                            {this.state.reportObject.map(
                              (parentCategory, index) => {
                                if (
                                  ...
                                  total_array = sum
                                  totalRow = totalRow + parentCategory.total_amount
                                  // total_array = total_array + parentCategory.amount_array
                                  // array = total_array.split(',').map(i => Number(i))
                                  ...
                                  return (
                                    <React.Fragment>
                                      ...
                                      <tr className="item-step1 title1 bdr-no">
                                            ...
                                            (amount, indexValue) => {
                                              ...
                                              return (
                                                <React.Fragment
                                                  key={indexValue}
                                                >
                                                  <td onDoubleClick={() => { this.valSet(parentCategory.customer_id, index, parentCategory.date_string_array) }}>
                                                    <span
                                                      className="text-right"
                                                      style={{
                                                        textAlign: "right",
                                        ...
                                        <td onDoubleClick={() => { this.goTotalBreak(parentCategory.customer_id) }}>
                                          <span className="text-right">
                                            {" "}
                                            {(new Intl.NumberFormat(this.state.language_code + '-' + this.state.country_sortname,
                            ...
                            <tr className="title-1">
                              ...
                              <td>
                                <span className="text-right pull-right">
                                  {(new Intl.NumberFormat(this.state.language_code + '-' + this.state.country_sortname,
                                    { style: 'currency', currency: this.state.home_currency }).format(totalRow)).replace(this.state.home_currency_symbol, '')}
                                  {/* {totalRow.toFixed(2)}  */}
                                </span>
                              </td>
                            </tr>
