...
class customer_module extends React.Component {
  ...
  componentDidMount() {
    ...
    if (start !== "" && start !== undefined && end !== "" && end !== undefined) {
      ...
      jQuery('#fromdate').val(start)
      jQuery('#todate').val(end)
  ...
  callAPIDATA() {
    ...
    let filter_options = {
      ...
      5: {
        condition: '',
        value: [{ customer_id: urlParams.get("selected-customer-id"), job_id: urlParams.get("selected-job-id") }],
        from: '',
        to: ''
      },
      6: {
          ...
          <div className='row'>
            ...
            <div className='main-wrap col-md-12 col-xs-12 pad-r-no'>
              ...
              <div className='content-top col-md-12 col-xs-12'>
                <h4 className='fw-sbold mar-t-no'>Customer Balance Transactions</h4>
