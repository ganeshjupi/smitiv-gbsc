...
class CusBalSummary extends React.Component {
  constructor(props) {
    super(props);
        ...
        <React.Fragment>
          {sub_categories &&
            sub_categories.map((itm, i) => {
              console.log("julyq1", Object.values(itm)[0].job_id);
                  ...
                  <React.Fragment key={i}>
                    {Object.values(itm)[0].sub_categories &&
                      ...
                      <tr className="item-step1 ">
                        ...
                        <td
                          onDoubleClick={() => {
                            this.goToOtherTotalBreak(
                              Object.values(itm)[0].customer_id,
                              Object.values(itm)[0].job_id
                            );
                          }}
                        >
  ...
  goToOtherDateBreak = (start, end, main, sub) => {
    ...
    window.open(
      "/customer_balance_transaction_history?selected-customer-id=" +
      main +
      "&selected-job-id=" +
      sub +
      "&start=" +
