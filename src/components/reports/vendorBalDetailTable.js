...
class VendorBalDetail extends React.Component {
  constructor(props) {
    super(props);
      ...
      return (
        <React.Fragment>
          ...
          <tr className="item-step1 title1 ">
            ...
            <td className="">
              <span>{i2.total_open_balance}</span>
            </td>
            <td className="">
            ...
            <td className="">
              <span>{i2.total_open_foreign_balance}</span>
            </td>
            <td className="">
              <span>{i2.total_foreign_debit}</span>
            </td>
            <td className="">
              <span>{i2.total_foreign_credit}</span>
            </td>
            <td className="">
              <span>{i2.total_foreign_amount}</span>
            </td>
            <td className="">
              <span>{""}</span>
            </td>
            ...
            i2.split_breakdown_string.map((item, i) => {
              return (
                <tr className="item-step1 istep-2 title1">
                  ...
                  <td>
                    <span className="">{i2.split_breakdown_amount[i]}</span>
                  </td>
                  <td>
                    <span className=" "></span>
                  </td>
                                  ...
                                  return (
                                    <React.Fragment key={i}>
                                      ...
                                      <tr className="item-step1 title1 bdr-no">
                                        ...
                                        <td className="">
                                          <span>{primaryObj.total_debit}</span>
                                        </td>
                                        <td className="">
                                          <span>{primaryObj.total_credit}</span>
                                        </td>
                                        <td className="">
                                          <span>{primaryObj.total_amount}</span>
                                        </td>
                                        <td className="">
                                          <span>{""}</span>
                                        </td>
...
export default VendorBalDetail;
