...
class vendor_balance_summary extends React.Component {
  constructor(props) {
    super(props)
  ...
  nextPage = (input) => {
    ...
    window.open("/vendor_balance_transaction_history?selected-vendor-id=" + input + "&start=" + this.state.start_date + "&end=" + this.state.end_date + "&range=" + this.state.date_range)
  }
  total = () => {
    var id = []
    window.open("/vendor_balance_transaction_history?filter_id=" + id + "&start=" + this.state.start_date + "&end=" + this.state.end_date + "&range=" + this.state.date_range)
          ...
          <div className='row'>
            ...
            <div className='main-wrap col-md-12 col-xs-12 pad-r-no'>
              <div className='top-bar col-md-12 col-xs-12 pad-r-no'>
                ...
                <span className='page-title hidden-xs'>Vendor Balance Summary</span>
                        ...
                        <div className='col-lg-8 col-md-12 pad-r-no'>
                          <div className='row'>
                            ...
                            {/* <div className='form-group col-md-12 col-xs-12 pad-no mar-b-no'>
                              <div className='col-md-4 col-sm-4' style={{ paddingLeft: 81 }}>
                                <label className='custom-checkbox'>
                                  <input
                                    type='checkbox'
                                    name
                          ...
                          <tbody>
                            {this.state.reportObject.map(
                              (parentCategory, index) => {
                                ...
                                console.log('asjhgdkja', parentCategory.sub_categories)
                                                    ...
                                                    {eachCategory.amount_array &&
                                                      eachCategory.amount_array.map(
                                                        (value, indexValue) => {
                                                          ...
                                                          return (
                                                            <React.Fragment>
                                                              <td onDoubleClick={() => { this.nextPage(parentCategory.vendor_id) }}>
                                    ...
                                    <tr className='item-step1'>
                                      ...
                                      {parentCategory.amount_array &&
                                        parentCategory.amount_array.map(
                                          (total, indexValue) => {
                                            grantTotal = grantTotal + parentCategory.last_total_amount
                                            return (
                            ...
                            <tr className='item-step1 title1 bdr-no'>
                              ...
                              {total_array &&
                                total_array.map(amount => {
                                  // console.log("jairam1", this.state.total_amnt_array)
                                  return (
...
export default vendor_balance_summary
