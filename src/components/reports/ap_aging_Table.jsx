...
class ApAgingTable extends React.Component {
  constructor(props) {
    super(props);
  ...
  goToDateTotalBreak(start, end) {
    ...
    window.open(
      "/ap_aging_transactions?vendor_id=" +
      id +
      "&start=" +
      date1 +
      "&end=" +
          ...
          <div className="row">
            ...
            <div className="">
              ...
              >
                ...
                <span className="page-title hidden-xs">A/P Aging Summary</span>
              ...
              <div className="col-md-12 col-xs-12 mar-top visible-xs">
                ...
                <span className="page-title">A/P Aging Summary</span>
              </div>
              {/* content-top Starts here */}
              <div className="content-top col-md-12 col-xs-12">
                <h4 className="fw-sbold mar-t-no">A/P Aging Summary</h4>
                          ...
                          <tbody>
                                ...
                                return <td>&nbsp;</td>
                                                              ...
                                                              {this.state
                                                                ...
                                                                <React.Fragment>
                                                                  ...
                                                                  <td>
                                                                    <span className="text-right">
                                                                      <a href="javascript:;">
                                                                        <Comma value={this.state.changetotal1} />
                                                              ...
                                                              {this.state
                                                                ...
                                                                <React.Fragment>
                                                                  ...
                                                                  <td>
                                                                    <span className="text-right">
                                                                      <a href="javascript:;">
                                                                        <Comma value={this.state.changetotal3} />
                                    ...
                                    <tr className="item-step1">
                                      ...
                                      >
                                        <span className="text-right">
                                          {" "}
                                          <Comma value={parentCategory.total_amount} />
                            ...
                            <tr className="item-step1 title1 bdr-no">
                              ...
                              {this.state.total_amnt_array &&
                                this.state.total_amnt_array.map(
                                  (eachDate, index) => {
                                    return (
                                      <td
                                        onDoubleClick={() => {
                                          this.dateTotalBreak(index);
                                        }}
                                      >
                                        <span className="text-right">
                                          <Comma value={eachDate} />
                              ...
                              >
                                <span className="text-right">
                                  <Comma value={parseFloat(this.state.totalAmount)} />
