...
class UnpaidBillTable extends React.Component {
  constructor(props) {
    super(props);
    ...
    this.state = {
      ...
      numberOfColumns: [],
      dateList: [],
      endDate: this.props.date[1],
      startDate: this.props.date[0],
        ...
        return (
          <React.Fragment>
            ...
            >
              <td className="">
                <span>
                  {i2.transaction_number != "" ? i2.transaction_number : ""}
                </span>
              </td>
              <td className="">
                <span>{i2.type}</span>
        ...
        return (
          <React.Fragment>
            ...
            >
              <td className="">
                <span>
                  {e1.transaction_number != "" ? e1.transaction_number : ""}
                </span>
              </td>
              <td className="">
                <span>{e1.type}</span>
          ...
          <div className="row">
            ...
            <div className="">
              ...
              <div className="content-top col-md-12 col-xs-12">
                <h4 className="fw-sbold mar-t-no">Unpaid Bills</h4>
...
export default connect(mapStateToProps, mapDispatchToProps)(UnpaidBillTable);
