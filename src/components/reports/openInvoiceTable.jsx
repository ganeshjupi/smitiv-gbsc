...
class OpenInvoiceTable extends React.Component {
  constructor(props) {
    super(props);
                ...
                <div className="content-top col-md-12 col-xs-12">
                  ...
                  <div className="row">
                    <div className="report-setting col-md-12 col-xs-12">
                      <form
                        className="custom-form form-inline col-md-12 col-xs-12 pad-no"
                        style={{ display: "none" }}
                      >
                        <div className="row">
...
// export default OpenInvoiceTable
...
export default connect(mapStateToProps, mapDispatchToProps)(OpenInvoiceTable);
