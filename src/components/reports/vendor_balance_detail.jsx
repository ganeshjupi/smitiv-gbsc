          ...
          <tr className="item-step1 sub-title">
            {this.state.coulmns_head.map((x, y) => {
              if (y === 0) {
                ...
                return <td  className={x.clsname}> <div> <Comma value={i2.prevoius_closing_balance} /></div></td>
              }else if(y == 26){
                return <td  className={x.clsname}> <div><Comma value={i2.prevoius_closing_foreign_balance} /></div></td>
              } else {
                return (
                                ...
                                <div style={{ float: "right" }}>
                                  ...
                                  >
                                   ...
                                   {this.state.sort_type == "desc" ? 
                                     <img src="images/icons8-down-arrow-24.png"/> :<img src="images/icons8-up-arrow-24.png"/>} 
                                  </a>
                                </div>
                              </div>
                            </div>
                                      ...
                                      <tr className="title-1">
                                        {this.state.coulmns_head.map((x, y) => {
                                          if (y === 0) {
                                            ...
                                            return <td  className={x.clsname}><Comma value={primaryObj.prevoius_closing_balance} /></td>
                                          }else if(y == 26){
                                            return <td  className={x.clsname}><Comma value={primaryObj.prevoius_closing_foreign_balance} /></td>
                                          } else {
                                            return (
