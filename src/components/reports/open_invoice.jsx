                                        ...
                                        <tr className="item-step1 title1 bdr-no">
                                          ...
                                          <td>
                                            <span className="">
                                              ...
                                              {/* {!isNaN(this.state.language_code + '-' + this.state.country_sortname,
 { style: 'currency', currency: this.state.home_currency }) && !isNaN(entry.total_open_balance) ?(new Intl.NumberFormat(this.state.language_code + '-' + this.state.country_sortname,
