...
class reviewedItems extends React.Component {
  ...
  dataTaggingFunc(file_id) {
    ...
    localStorage.setItem('comingFrom', 'Reviewed Items')
    localStorage.setItem(
      "vendor_bill",
      JSON.stringify(['from_inbox_pages', this.state.list_id, file_id, 'Reviewed Items'])
    );
          ...
          <div className="row">
            ...
            <div className="main-wrap col-md-12 col-xs-12 pad-r-no">
              <div className="top-bar col-md-12 col-xs-12 pad-r-no">
                ...
                <span className="page-title hidden-xs">Reviewed Items</span>
                            ...
                            if (inbox_data.id !== "") {
                              ...
                              if (get_file_path != "") {
                                ...
                                if (get_file_path.length > 1) {
                                  ...
                                  console.log('222221',arr_reverse[0])
                                  var urlname = arr_reverse[0].split('-$$$$')
                                  console.log('222222',urlname)
                                  var shiftval = urlname.slice(1);
                                  console.log('222223',shiftval)
                                  // spliting file name only
                                  var get_file_ext = arr_reverse[0].substring(
                                    arr_reverse[0].lastIndexOf(".") + 1,
                                    arr_reverse[0].length
