...
class create_estimate extends React.Component {
  constructor(props) {
    super(props)
              ...
              <div className='main-wrap col-md-12 col-xs-12 pad-r-no'>
                <div className='top-bar col-md-12 col-xs-12 pad-r-no'>
                  ...
                  <ul class='list-unstyled breadcrumb page-title hidden-xs'>
                    <li>
                      <a href='javascript: ;'>Create Estimate</a>
                    </li>
                            ...
                            <li>
                              <a href='javascript:;' onClick={
                                () => {
                                  ...
                                  this.props.history.push({ pathname: '/create_invoice', state: { detail: data } }) ///from estimate to invoice is using data state object
                                }}>Create invoice</a>
                            </li>
                            <li>
                              <a href='javascript:;' onClick={
                                () => {
                                  ...
                                  this.props.history.push('/create_salesorder')
                                }
                              ...
                              <a href='javascript:;'
                                onClick={
                                  () => {
                                    ...
                                    // }))
                                    this.props.history.push({ pathname: '/create_purchaseorder', state: { data: data } }) ///pass  estimate details to purchase order details in this.props.state in data object
                                  }
                                  // (e)=>this.props.history.push(
                                  //   '/create_salesorder',
                                  //   [this.collectdata()]
