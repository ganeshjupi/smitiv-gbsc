...
class AddNewEmployee extends React.Component {
  ...
  handleChangeContacts = () => {
    ...
    this.setState({ bankContact: bankArray })
    ...
    for (var i = 0; i < rowlength; i++) {
      ...
      var acc = jQuery('#bnkacc' ).val()
      var ifsc = jQuery('#bnkifsc' ).val()
      let bankDet = {
        account_no: acc,
        ifsc_code: ifsc
      }
      ...
      bankArray.push(bankDet)
      console.log('shippingobj', bankDet)
      this.setState({ bankDet: bankDet })
      resultArray.push(current_item)
    }
  }

  handleChangeContacts1 = () => {
    var resultArray = []
  ...
  addEmployee = () => {
    ...
    let account_no = jQuery('#bnkacc').val()
    let ifsc_code = jQuery('#bnkifsc').val()
  ...
  render() {
    console.log('myatjhjtribute', this.state.wrkcontactArray)
    var data = ''
                          ...
                          <div className='form-group col-lg-4 col-md-6 col-sm-6 col-xs-12'>
                            ...
                            <div>
                              ...
                              >
                                ...
                                <option data-status='0'>Male</option>
                                <option data-status='1'>Female</option>
                            ...
                            <div className='row'>
                              ...
                              <div className='form-group col-lg-4 col-md-6 col-sm-6 col-xs-12'>
                                ...
                                <div>
                                  ...
                                  >
<option value="1qw" selected={true}>Add New</option>
                  ...
                  <form className='custom-form row'>
                    ...
                    <div className='form-group col-md-12 col-xs-12 btn-sec pad-no mar-b-no'>
                      <button
                        ...
                        data-dismiss='modal'
                        onClick={() => {jQuery('#department').val('0');this.setState({ roleStringLen: false })
                        }}
                      >
                        Cancel
                      </button>
                  ...
                  <form className='custom-form row'>
                    ...
                    <div className='form-group col-md-12 col-xs-12 btn-sec pad-no mar-b-no'>
                      <button
                        className='btn btn-lightgray'
                        data-dismiss='modal'
                        onClick={() => {  jQuery('#employee_type').val('0');
                        this.setState({ roleStringLen: false })
                        }}
                      >
                        Cancel
                  ...
                  <form className='custom-form row'>
                    ...
                    <div className='form-group col-md-12 col-xs-12 btn-sec pad-no mar-b-no'>
                      <button
                        className='btn btn-lightgray'
                        data-dismiss='modal'
                        onClick={() => {  jQuery('#office_location').val('0');
                        }}
                      >
                        Cancel
                      </button>
