...
class UserProfile extends React.Component {
  ...
  uploadProfilePicture = (uploadedPicture) => {
    ...
    FetchAllApi.editProfilePicture(
      client_id,
      user_id,
      profile_pic,
      (err, response) => {
                ...
                <div className="profile-cont col-md-12 col-xs-12">
                  ...
                  <div className="prof-cont-row col-md-12 col-xs-12">
                    <div class="row">
                      ...
                      {/* <div className="prof-cont-row col-md-12 col-xs-12">
                    <div className="row">
                      <div className="col-md-8 col-xs-12 pass-sec">
                        ...
                        <a href="javascript:;" className="show-pass">
                          <img
                            className="visible-icon"
                            src="images/visible-icon.svg"
                            alt="icon"
                            onClick={() => { this.textTypeChange("text") }}
                          />
                          <img
                            className="invisible-icon"
                            src="images/invisible-icon.svg"
                            alt="icon"
                            onClick={() => { this.textTypeChange("password") }}
                          />
                        </a> */}
                      {/* </div> */}
                      <div className="col-md-4 col-xs-12 text-right">
                    ...
                    <div className="row">
                      ...
                      <div className="col-md-4 col-xs-12 text-right">
                        <button
                          ...
                          onClick={() =>
                            window.jQuery("#modal_delete").modal("show")
                          }
                        >
                          Continue
                        </button>
