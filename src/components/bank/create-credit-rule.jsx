...
class CreditRule extends React.Component {
  ...
  componentDidMount() {
    jQuery('#credit-rule').show();
    jQuery('#credit').addClass('active');
                ...
                <div>
                  ...
                  <div className="content-top col-md-12 col-xs-12">
                    <ul className="nav nav-pills transparent nowrap">
                      ...
                      <li className="active"><a data-toggle="pill" onClick={() => { this.props.history.push('/create-transfer-rule') }}>Credit Amount Rule</a></li>
                      <li><a data-toggle="pill" >Transfer Amount Rule</a></li>
                    </ul>
                  </div>
                  {/* content-top Starts here */}
