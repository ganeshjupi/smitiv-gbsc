...
class WriteCheque extends React.Component {
  ...
  save = () => {
    console.log(this.convert_date(jQuery("#transaction_date").val()),moment(this.state.transaction_date).format("YYYY-MM-DD"),this.state.transaction_date)
    this.state.item_array.map((item, idx) => {
      if (item.catagory_id == "" &&  item.amount == "") {
        ...
        let item_list = [];
        //
        console.log(moment(this.state.transaction_date).format("YYYY-MM-DD"),this.state.transaction_date)
        this.state.item_array &&
              ...
              response.data.map((item, i) => {
                if (item.id == this.props.location.state[0]) {
                  ...
                  this.setState({
                    ...
                    bankCurency: item.currency,
                    exchange_rate: this.state.currency_clone[item.currency],
              ...
              <div className="content-top col-md-12 col-xs-12">
                <form className="custom-form row">
                  <div className="form-group col-md-4 mar-b-no">
                    ...
                    {this.state.select_bank_fill == true ? (
