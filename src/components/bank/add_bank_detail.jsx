...
class AddBankDetail extends React.Component {
  constructor(props) {
    super(props);
                  ...
                  <div className="content-top col-md-12 col-xs-12 pad-no mar-btm bg-trans">
                    <form className="custom-form">
                      <div className="col-md-6 col-xs-12 add-bank-dtls">
                        <div className="row">
                          <p className="fw-sbold mar-btm">
                            Enter your DBS Bank account details
                          </p>
                          <div className="transfer-top">
                            <div className="row">
                              ...
                              <div className="form-group col-md-12">
                                ...
                                <div className="custom-select-drop dropdown">
                                  ...
                                  <ul className="dropdown-menu">
                                    ...
                                    <li>
                                      <a href="javascript:;">Account Type 1</a>
                                    </li>
                                    <li>
                                      <a href="javascript:;">Account Type 2</a>
                                    </li>
                                  </ul>
                                </div>
                              </div>
                              ...
                              <div className="form-group col-md-12 text-center">
                                <button className="btn btn-dashed-line">
                                  <img
                                    className="img-responsive"
                                    src="images/plus-add.svg"
                                    alt="icon"
                                  />
                                  Add Another DBS Bank Account
                                </button>
                              </div>
                            </div>
                          </div>
