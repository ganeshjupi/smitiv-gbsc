...
class AddBankInternet extends React.Component {
  constructor(props) {
    super(props);
          ...
          <div className="row">
            ...
            <div className="main-wrap col-md-12 col-xs-12 pad-r-no">
              ...
              <div className="col-md-12 col-xs-12 mar-top visible-xs">
                ...
                <span className="page-title">Add Bank Account</span>
              </div>
                ...
                <div className="content-sec col-md-12 col-xs-12 pad-no">
                  ...
                  <div className="content-top col-md-12 col-xs-12 pad-no mar-btm bg-trans">
                    <form className="custom-form">
                      <div className="col-md-6 col-xs-12 add-bank-dtls">
                        <div className="row">
                          <p className="fw-sbold mar-b-no">
                            Enter your DBS Bank Internet Banking Details
                          </p>
                          <small className="mar-btm">
                            You can shut off automatic bank feeds at any time
                          </small>
                            ...
                            <div className="row">
                              <div className="form-group col-md-12">
                                ...
                                <input
                                  type="text"
                                  className="form-control"
                                  placeholder="Eg: Business Account"
                                  name
                                />
                              </div>
                              <div className="form-group col-md-12">
                              ...
                              <div className="form-group col-md-12">
                                <label className="custom-checkbox mar-t-no small">
                                  <input
                                    type="checkbox"
                                    name="tax-item"
                                  ...
                                  <a href="javascript:;">
                                    {" "}
                                    Automatic Bank Feed Terms &amp; Conditions
                                  </a>
                          ...
                          <div className="btn-btm-wrap">
                            ...
                            <div>
                              ...
                              <button className="btn btn-blue mar-lft-5">
                                Next
                              </button>
                            </div>
                          </div>
...
export default AddBankInternet;
